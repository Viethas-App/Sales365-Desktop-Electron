"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_cafe_desktop_menu_management_cashflow_cashflow_module_ts"],{

/***/ 17921:
/*!*****************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/cashflow/cashflow.component.ts ***!
  \*****************************************************************************/
...
class CashflowComponent {
    ...
    gotoCashbook() {
        if (this.vhAuth.checkMyPermission("cashflow_view_cashbook"))
            this.router.navigate(['/cafe/dashboard/management/cashflow/cashbook']);
        else
    ...
    gotoWallet() {
        if (this.vhAuth.checkMyPermission("management_enable_payment"))
            this.router.navigate(['/cafe/dashboard/management/cashflow/wallet']);
        else
            this.vhComponent.showToast(1500, this.languageService.translate('You do not have this rights'), "alert-toast");
    }
    gotoDiary() {
        if (this.vhAuth.checkMyPermission("cashflow_enable_diary"))
            this.router.navigate(['/cafe/dashboard/management/cashflow/diary']);
        else
            this.vhComponent.showToast(1500, this.languageService.translate('You do not have this rights'), "alert-toast");
    }
    ...
    gotoBeginningSupplierLiability() {
        if (this.vhAuth.checkMyPermission("cashflow_enable_debt_supplier_begin"))
            this.router.navigate(['/cafe/dashboard/management/cashflow/beginning-supplier-liability']);
        else
            this.vhComponent.showToast(1500, this.languageService.translate('You do not have this rights'), "alert-toast");
    }
    gotoCustomerDebt() {
    ...
    gotoBeginningCustomerDebt() {
        if (this.vhAuth.checkMyPermission("cashflow_enable_debt_customer_begin"))
            this.router.navigate(['/cafe/dashboard/management/cashflow/beginning-customer-debt']);
        else
            this.vhComponent.showToast(1500, this.languageService.translate('You do not have this rights'), "alert-toast");
    }
    gotoReceiving() {
        if (this.vhAuth.checkMyPermission("branch_management_receive_money"))
            this.router.navigate(['/cafe/dashboard/management/cashflow/receiving']);
        else
            this.vhComponent.showToast(1500, this.languageService.translate('You do not have this rights'), "alert-toast");
    }
    gotoTransfers() {
...
CashflowComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: CashflowComponent, selectors: [["app-cashflow"]], decls: 127, vars: 39, consts: [["nz-row", ""], ["nz-col", "", "nzSpan", "24", 1, "title"], ["nz-row", "", 1, "cus-row"], ["nz-col", "", "nzSpan", "6", 1, "center-all-content", "item-cus"], [1, "ng-item", "center-all-content", 3, "click"], ["nz-col", "", "nzSpan", "24", 1, "center-all-content"], ["src", "./assets/icon/management/cashbook.svg"], [1, "center-text", "small-size"], ["src", "./assets/icon/management/receipts.svg"], ["src", "./assets/icon/management/expenses.svg"], ["src", "./assets/icon/management/diary.svg"], ["src", "./assets/icon/management/debt_begin.svg"], ["src", "./assets/icon/management/loan_begin.svg"], ["src", "./assets/icon/management/wallet.svg"], ["src", "./assets/icon/management/transfers.svg"], ["src", "./assets/icon/management/receiving_money.svg"], ["src", "./assets/icon/management/doisoatthuchi.svg"], [1, "center-text"]], template: function CashflowComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ng_zorro_antd_layout__WEBPACK_IMPORTED_MODULE_5__.NzLayoutComponent, ng_zorro_antd_grid__WEBPACK_IMPORTED_MODULE_6__.NzRowDirective, ng_zorro_antd_grid__WEBPACK_IMPORTED_MODULE_6__.NzColDirective, _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonIcon], pipes: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__.TranslatePipe], styles: ["nz-layout[_ngcontent-%COMP%] {\n  background: #ffffff 0% 0% no-repeat padding-box;\n  box-shadow: 0px 2px 6px #00000014;\n  border-radius: 5px;\n  padding: 16px;\n  margin-top: 30px;\n  height: 95%;\n}\nnz-layout[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  color: var(--ion-color-vh-green);\n  font-size: 1.1rem;\n}\nnz-layout[_ngcontent-%COMP%]   .cus-row[_ngcontent-%COMP%] {\n  max-width: 1366px;\n  margin-top: 5px;\n}\nnz-layout[_ngcontent-%COMP%]   .cus-row[_ngcontent-%COMP%]   .ng-item[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 100%;\n  box-shadow: 0px 3px 6px #00000040;\n  border-radius: 15px;\n  flex-direction: column;\n  cursor: pointer;\n}\nnz-layout[_ngcontent-%COMP%]   .cus-row[_ngcontent-%COMP%]   .ng-item[_ngcontent-%COMP%]   ion-icon[_ngcontent-%COMP%] {\n  font-size: 4rem;\n  color: var(--ion-color-vh-green);\n}\nnz-layout[_ngcontent-%COMP%]   .item-cus[_ngcontent-%COMP%] {\n  padding: 16px;\n  height: 24vh;\n}\nnz-layout[_ngcontent-%COMP%]   .center-text[_ngcontent-%COMP%] {\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/***/ 47138:
/*!**************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/cashflow/cashflow.module.ts ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _cashflow_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cashflow.component */ 17921);
...
const routes = [
    ...
    {
        path: 'cashbook',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_cashbook_cashbook_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./cashbook/cashbook.module */ 57391)).then(m => m.CashbookModule)
    },
    {
        path: 'receipts',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_receipts_receipts_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./receipts/receipts.module */ 90407)).then(m => m.ReceiptsModule)
    },
    {
        path: 'expenses',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_expenses_expenses_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./expenses/expenses.module */ 87949)).then(m => m.ExpensesModule)
    },
    {
        path: 'wallet',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_wallet_wallet_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./wallet/wallet.module */ 52999)).then(m => m.WalletModule)
    },
    {
        path: 'diary',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_diary_diary_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./diary/diary.module */ 54842)).then(m => m.DiaryModule)
    },
    {
        path: 'customer-debt',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_customer-debt_customer-debt_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./customer-debt/customer-debt.module */ 98110)).then(m => m.CustomerDebtModule)
    },
    {
        path: 'supplier-liability',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_supplier-liability_supplier-liability_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./supplier-liability/supplier-liability.module */ 32015)).then(m => m.SupplierLiabilityModule)
    },
    {
        path: 'beginning-customer-debt',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_beginning-customer-debt_beginning-customer-debt-c301e3").then(__webpack_require__.bind(__webpack_require__, /*! ./beginning-customer-debt/beginning-customer-debt.module */ 5346)).then(m => m.BeginningCustomerDebtModule)
    },
    {
        path: 'beginning-supplier-liability',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_beginning-supplier-liability_beginning-supplier-711d55").then(__webpack_require__.bind(__webpack_require__, /*! ./beginning-supplier-liability/beginning-supplier-liability.module */ 2677)).then(m => m.BeginningSupplierLiabilityModule)
    },
    {
        path: 'transfers',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_transfers_transfers_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./transfers/transfers.module */ 79080)).then(m => m.TransfersModule)
    },
    {
        path: 'receiving',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_cafe_desktop_menu_management_cashflow_receiving-money_receiving-money_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./receiving-money/receiving-money.module */ 74408)).then(m => m.ReceivingMoneyModule)
    },
    {
        path: 'money-control',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_cafe_interface_vh-order-invoice_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_cafe_desktop_menu_management_cashflow_money-control_money-control_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./money-control/money-control.module */ 60945)).then(m => m.MoneyControlModule)
    }
];
...
//# sourceMappingURL=src_app_cafe_desktop_menu_management_cashflow_cashflow_module_ts.js.map