"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_cafe_desktop_menu_management_design_design-barcode_label-lots_label-lots_module_ts"],{

/***/ 64797:
/*!**********************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-lots/detail/detail.component.ts ***!
  \**********************************************************************************************************/
...
function DetailComponent_div_105_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r17.type == "name" || item_r17.type == "barcode-text" || item_r17.type == "lot_number" && item_r17.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
class DetailComponent {
    ...
    ngOnInit() {
        this.listUpdateCoor = [
            ...
            {
                type: 'lot_number',
                y: this.stamp.property[5].y,
                x: this.stamp.property[5].x
            }
        ];
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/design/design-label/label-lots']);
    }
    updateZindex() {
            ...
            this.vhQuery.updateDoc("barcode_designs", this.stamp._id, {
                property: [{
                    ...
                    },
                    {
                        ...
                        hidden_text: this.stamp.property[2].hidden_text,
                    },
                    {
                        type: 'date_mfg',
                    ...
                    {
                        type: 'lot_number',
                        label: this.stamp.property[5].label,
                        font_family: this.stamp.property[5].font_family,
                        font_size: this.stamp.property[5].font_size,
                        text_align: this.stamp.property[5].text_align,
                        status: this.stamp.property[5].status,
                        font_weight: this.stamp.property[5].font_weight,
                        font_style: this.stamp.property[5].font_style,
                        text_decoration: this.stamp.property[5].text_decoration,
                        white_space: this.stamp.property[5].white_space,
                        y: this.listUpdateCoor[5].y,
                        x: this.listUpdateCoor[5].x,
                        height: this.stamp.property[5].height,
                        value: this.stamp.property[5].value,
                        width: this.stamp.property[5].width,
                        index: 5,
                        z_index: this.stamp.property[5].z_index,
                    }]
            }).then((bool) => {
    ...
    onDragEnded(event, item) {
        ...
        switch (item.type) {
            ...
            case 'lot_number': {
                this.listUpdateCoor[5].y = y;
                this.listUpdateCoor[5].x = x;
                break;
            }
        }
    }
    gotoPrintBarcode() {
        ...
        switch (this.col) {
            case 1: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-lots/print-one-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, lot_number: this.stamp.property[4].value, date_mfg: this.stamp.property[2].value, date_exp: this.stamp.property[1].value } } });
                break;
            }
            case 2: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-lots/print-two-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, lot_number: this.stamp.property[4].value, date_mfg: this.stamp.property[2].value, date_exp: this.stamp.property[1].value } } });
                break;
            }
            case 3: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-lots/print-three-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, lot_number: this.stamp.property[4].value, date_mfg: this.stamp.property[2].value, date_exp: this.stamp.property[1].value } } });
                break;
            }
            case 4: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-lots/print-four-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, lot_number: this.stamp.property[4].value, date_mfg: this.stamp.property[2].value, date_exp: this.stamp.property[1].value } } });
                break;
            }
            case 5: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-lots/print-five-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, lot_number: this.stamp.property[4].value, date_mfg: this.stamp.property[2].value, date_exp: this.stamp.property[1].value } } });
                break;
            }
            default: {
...
DetailComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: DetailComponent, selectors: [["app-detail"]], decls: 112, vars: 99, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["nz-row", ""], ["nz-col", "", "nzSpan", "18", 1, "left-all-content"], [1, "title"], ["nz-row", "", 2, "background", "#f0f2f5"], ["nz-col", "", "nzSpan", "24", 2, "padding", "8px", "border-bottom", "1px solid #d3d3d3"], ["nz-col", "", "nzSpan", "4"], ["nz-col", "", "nzSpan", "5", 1, "center-all-content"], ["nz-col", "", "nzSpan", "24"], ["nz-col", "", "nzSpan", "4", 2, "display", "flex"], ["nzMode", "default", "nzPlaceHolder", "K\u00EDch th\u01B0\u1EDBc ph\u00F4ng ch\u1EEF", 1, "font-text-size", 2, "width", "60px", 3, "ngModel", "ngModelChange"], [3, "nzLabel", "nzValue", 4, "ngFor", "ngForOf"], ["nzMode", "default", "nzPlaceHolder", "Ki\u1EC3u ch\u1EEF", 1, "font-text-size", 2, "width", "100%", 3, "ngModel", "ngModelChange"], [1, "right-all-content", 3, "ngStyle"], ["nz-button", "", 1, "font-text-btn", "font-text-btn-bold", 3, "disabled", "nzType", "click"], ["nz-button", "", 1, "font-text-btn", "font-text-btn-italic", 3, "disabled", "nzType", "click"], ["nz-icon", "", "nzType", "italic", "nzTheme", "outline"], ["nz-button", "", 1, "font-text-btn", "font-text-btn-underline", 3, "disabled", "nzType", "click"], ["nz-icon", "", "nzType", "underline", "nzTheme", "outline"], [1, "right-all-content"], ["nz-button", "", 1, "font-text-btn", 3, "nzType", "click"], ["nz-icon", "", "nzType", "align-left", "nzTheme", "outline"], ["nz-icon", "", "nzType", "align-center", "nzTheme", "outline"], ["nz-icon", "", "nzType", "align-right", "nzTheme", "outline"], ["nz-button", "", 1, "font-text-btn", "center-all-content", 3, "disabled", "nzType", "click"], ["src", "assets/icon/management/design-barcode/icon-text-justify.svg", 2, "font-size", "1.2rem", 3, "color"], ["nz-checkbox", "", 2, "margin-left", "8px", 3, "ngModel", "nzDisabled", "ngModelChange"], ["style", "width: 250px;", 3, "nzPlaceHolder", "ngModel", "ngModelChange", 4, "ngIf"], ["nz-button", "", 1, "center-all-content", 3, "nzType", "click"], ["nz-icon", "", "nzType", "eye", "nzTheme", "outline"], ["nz-row", "", 2, "background", "#f0f2f5", "padding", "8px"], ["nz-col", "", "nzSpan", "6", 1, "evenly-all-content", 2, "justify-content", "space-between"], ["nz-button", "", "nzType", "default", 1, "center-all-content", 2, "margin-right", "16px", 3, "click"], ["nz-icon", "", "nzType", "printer", "nzTheme", "outline"], ["nz-button", "", "nzType", "default", 1, "btn-add", "center-all-content", 3, "click"], ["nz-icon", "", "nzType", "save", "nzTheme", "outline"], ["nz-col", "", "nzSpan", "18", 1, "evenly-all-content"], [4, "ngIf"], ["nz-input", "", "type", "text", 2, "width", "150px", "padding", "8px", 3, "ngModel", "disabled", "ngModelChange", "blur"], ["nz-input", "", "type", "number", 2, "width", "60px", "padding", "8px 0 8px 8px", 3, "max", "ngModel", "ngModelChange"], ["nz-row", "", "id", "scroll", 2, "height", "100%", "padding-top", "16px"], ["nz-col", "", "nzSpan", "24", 1, "center-all-content", "hideScrollbar", 2, "overflow", "auto", "padding-top", "16px", 3, "ngStyle", "click"], ["id", "stamp-test", 2, "height", "100%", "margin-top", "-1.5mm", "margin-left", "0.05in", "z-index", "2"], [1, "stamp", 3, "ngStyle"], ["id", "boundary", 1, "example-boundary", 2, "position", "relative", "overflow", "hidden", 3, "ngStyle"], ["style", "display: flex;position: absolute;overflow: hidden;", "cdkDragBoundary", ".example-boundary", "cdkDrag", "", 3, "id", "ngClass", "ngStyle", "click", "mousedown", "cdkDragEnded", 4, "ngFor", "ngForOf"], [3, "nzVisible", "nzTitle", "nzVisibleChange", "nzOnCancel", "nzOnOk"], [4, "nzModalContent"], ["nzCancelText", "", 3, "nzVisible", "nzTitle", "nzVisibleChange", "nzOnCancel", "nzOnOk"], [3, "nzLabel", "nzValue"], [2, "width", "250px", 3, "nzPlaceHolder", "ngModel", "ngModelChange"], [3, "nzValue", "nzLabel", 4, "ngFor", "ngForOf"], [3, "nzValue", "nzLabel"], ["nz-input", "", "type", "text", 2, "width", "150px", "padding", "8px", 3, "ngModel", "ngModelChange"], ["cdkDragBoundary", ".example-boundary", "cdkDrag", "", 2, "display", "flex", "position", "absolute", "overflow", "hidden", 3, "id", "ngClass", "ngStyle", "click", "mousedown", "cdkDragEnded"], ["style", " overflow: hidden;line-height: 1;width: 100%;", 3, "ngStyle", 4, "ngIf"], ["style", " height: 100%;line-height: 1;width: 100%;", 3, "ngStyle", 4, "ngIf"], ["class", "barcode", 3, "ngStyle", 4, "ngIf"], [2, "overflow", "hidden", "line-height", "1", "width", "100%", 3, "ngStyle"], [2, "height", "100%", "line-height", "1", "width", "100%", 3, "ngStyle"], [1, "barcode", 3, "ngStyle"], [3, "ngModel", "ngModelChange"], ["nzLabel", "1", 3, "nzValue"], ["nzLabel", "2", 3, "nzValue"], ["nzLabel", "3", 3, "nzValue"], ["nzLabel", "4", 3, "nzValue"], ["nzLabel", "5", 3, "nzValue"], ["type", "number", "nz-input", "", 3, "ngModel", "placeholder", "ngModelChange"], [2, "display", "grid"], ["nz-checkbox", "", 2, "margin", "0", 3, "ngModel", "ngModelChange"]], template: function DetailComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [ng_zorro_antd_grid__WEBPACK_IMPORTED_MODULE_8__.NzRowDirective, ng_zorro_antd_icon__WEBPACK_IMPORTED_MODULE_9__.NzIconDirective, ng_zorro_antd_core_transition_patch__WEBPACK_IMPORTED_MODULE_10__["ɵNzTransitionPatchDirective"], ng_zorro_antd_layout__WEBPACK_IMPORTED_MODULE_11__.NzLayoutComponent, ng_zorro_antd_grid__WEBPACK_IMPORTED_MODULE_8__.NzColDirective, ng_zorro_antd_select__WEBPACK_IMPORTED_MODULE_12__.NzSelectComponent, _angular_forms__WEBPACK_IMPORTED_MODULE_13__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_13__.NgModel, _angular_common__WEBPACK_IMPORTED_MODULE_14__.NgForOf, _angular_common__WEBPACK_IMPORTED_MODULE_14__.NgStyle, ng_zorro_antd_button__WEBPACK_IMPORTED_MODULE_15__.NzButtonComponent, ng_zorro_antd_core_wave__WEBPACK_IMPORTED_MODULE_16__.NzWaveDirective, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonIcon, ng_zorro_antd_checkbox__WEBPACK_IMPORTED_MODULE_17__.NzCheckboxComponent, _angular_common__WEBPACK_IMPORTED_MODULE_14__.NgIf, ng_zorro_antd_input__WEBPACK_IMPORTED_MODULE_18__.NzInputDirective, _angular_forms__WEBPACK_IMPORTED_MODULE_13__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_13__.MaxValidator, _angular_forms__WEBPACK_IMPORTED_MODULE_13__.NumberValueAccessor, ng_zorro_antd_modal__WEBPACK_IMPORTED_MODULE_19__.NzModalComponent, ng_zorro_antd_modal__WEBPACK_IMPORTED_MODULE_19__.NzModalContentDirective, ng_zorro_antd_select__WEBPACK_IMPORTED_MODULE_12__.NzOptionComponent, _angular_cdk_drag_drop__WEBPACK_IMPORTED_MODULE_20__.CdkDrag, _angular_common__WEBPACK_IMPORTED_MODULE_14__.NgClass], pipes: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_21__.TranslatePipe, _angular_common__WEBPACK_IMPORTED_MODULE_14__.DatePipe], styles: [".row-back[_ngcontent-%COMP%] {\n  margin-top: 8px;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n}\n.row-back[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  font-size: 0.8rem;\n}\nnz-layout[_ngcontent-%COMP%] {\n  background: #ffffff 0% 0% no-repeat padding-box;\n  box-shadow: 0px 2px 6px #00000014;\n  border-radius: 5px;\n  padding: 16px;\n  height: 95%;\n}\nnz-layout[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  color: var(--ion-color-vh-green);\n  font-size: 1.1rem;\n}\nnz-layout[_ngcontent-%COMP%]   .center-text[_ngcontent-%COMP%] {\n  text-align: center;\n}\nnz-layout[_ngcontent-%COMP%]   .stamp[_ngcontent-%COMP%] {\n  border: 1px solid #414141;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-family[_ngcontent-%COMP%] {\n  min-width: 150px;\n  max-width: 200px;\n  margin: 6px;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-size[_ngcontent-%COMP%] {\n  min-width: 60px;\n  margin: 6px;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-color[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  padding: 0;\n  align-items: center;\n  height: 32px;\n  max-width: 50px;\n  margin: 6px;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-color[_ngcontent-%COMP%]   input[_ngcontent-%COMP%] {\n  width: 60%;\n  height: 5px;\n  background: #ff0909;\n  border: none;\n  outline: none;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-color[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:focus, nz-layout[_ngcontent-%COMP%]   .font-text-color[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:active {\n  border: none;\n  outline: none;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-btn[_ngcontent-%COMP%] {\n  height: 32px;\n  width: 50px;\n  margin: 6px;\n  padding: 0;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-btn-bold[_ngcontent-%COMP%] {\n  font-weight: bold;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-btn-italic[_ngcontent-%COMP%] {\n  font-style: italic;\n}\nnz-layout[_ngcontent-%COMP%]   .font-text-btn-underline[_ngcontent-%COMP%] {\n  text-decoration: underline;\n}\n.selected[_ngcontent-%COMP%] {\n  color: var(--ion-color-vh-green);\n  border: 0.5px solid var(--ion-color-vh-green);\n}\n.cdk-drag-preview[_ngcontent-%COMP%] {\n  box-sizing: border-box;\n  border-radius: 4px;\n  box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2), 0 8px 10px 1px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12);\n}\n.border-left[_ngcontent-%COMP%] {\n  border-left: 1px solid #929292;\n  padding-left: 8px;\n}\n.beetween-all-content[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n}\n.evenly-all-content[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  justify-content: space-evenly;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/***/ 65036:
/*!*******************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-lots/label-lots.component.ts ***!
  \*******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class LabelLotsComponent {
        ...
        this.vhComponent.showLoading('').then(() => {
            this.vhQuery.addDoc("barcode_designs", Object.assign(Object.assign({}, this.formAdd.value), { id_branch: this.vhQueryCafe.getDefaultBranch()._id, property: [
                    ...
                    },
                    {
                        ...
                        "white_space": "nowrap",
                        "font_style": "normal",
                        "value": "2024-02-02T02:31:05.763Z",
                        "x": 1,
                        "label": "NSX",
                        "text_decoration": "none",
                        "status": true,
    ...
    gotoEdit(item) {
        this.router.navigate(['/cafe/dashboard/management/design/design-label/label-lots/detail'], { state: item });
        // switch(item.col){
        //   case 2:{
        //     this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products/detail'], { state: item });
        //     break;
        //   }
        //   case 3:{
        //     this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products/detail-three-col'], { state: item });
        //     break;
        //   }
        //   default :{
        //     this.vhComponent.alertMessageDesktop( "error",this.languageService.translate("Không hỗ trợ kiểu tem này"))
    ...
    deleteBarcode(item, index) {
        this.nzModalService.confirm({
            ...
            nzOnOk: () => {
                this.vhComponent.showLoading('').then(() => {
                    if (this.vhQueryCafe.getlocalProducts().filter(i => i.id_design_barcode_lot == item._id).length) {
...
/***/ 87481:
/*!****************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-lots/label-lots.module.ts ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _label_lots_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./label-lots.component */ 65036);
...
/* harmony import */ var _print_one_col_print_one_col_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./print-one-col/print-one-col.component */ 29863);
/* harmony import */ var _print_four_col_print_four_col_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./print-four-col/print-four-col.component */ 75157);
/* harmony import */ var _print_five_col_print_five_col_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./print-five-col/print-five-col.component */ 54900);
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./detail/detail.component */ 64797);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/forms */ 1707);
/* harmony import */ var _print_two_col_print_two_col_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./print-two-col/print-two-col.component */ 37170);
/* harmony import */ var _print_three_col_print_three_col_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./print-three-col/print-three-col.component */ 94843);
...
const routes = [
    ...
    {
        path: 'print-one-col',
        component: _print_one_col_print_one_col_component__WEBPACK_IMPORTED_MODULE_1__.PrintOneColComponent
    },
    {
        path: 'print-four-col',
...
/***/ 54900:
/*!**************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-lots/print-five-col/print-five-col.component.ts ***!
  \**************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function PrintFiveColComponent_div_17_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r9.type == "name" || item_r9.type == "barcode-text" || item_r9.type == "lot_number" && item_r9.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_17_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r23.type == "name" || item_r23.type == "barcode-text" || item_r23.type == "lot_number" && item_r23.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_17_div_4_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r37.type == "name" || item_r37.type == "barcode-text" || item_r37.type == "lot_number" && item_r37.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_17_div_5_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r51.type == "name" || item_r51.type == "barcode-text" || item_r51.type == "lot_number" && item_r51.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_17_div_6_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r65.type == "name" || item_r65.type == "barcode-text" || item_r65.type == "lot_number" && item_r65.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_19_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r85.type == "name" || item_r85.type == "barcode-text" || item_r85.type == "lot_number" && item_r85.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_19_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r99.type == "name" || item_r99.type == "barcode-text" || item_r99.type == "lot_number" && item_r99.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_19_div_4_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r113.type == "name" || item_r113.type == "barcode-text" || item_r113.type == "lot_number" && item_r113.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_19_div_5_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r127.type == "name" || item_r127.type == "barcode-text" || item_r127.type == "lot_number" && item_r127.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFiveColComponent_div_19_div_6_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r141.type == "name" || item_r141.type == "barcode-text" || item_r141.type == "lot_number" && item_r141.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
class PrintFiveColComponent {
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/design/design-label/label-lots/detail'], { state: this.stamp.barcode });
    }
    Print() {
        if (this.platform.is("electron"))
            this.printElectron();
...
/***/ 75157:
/*!**************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-lots/print-four-col/print-four-col.component.ts ***!
  \**************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function PrintFourColComponent_div_17_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r8.type == "name" || item_r8.type == "barcode-text" || item_r8.type == "lot_number" && item_r8.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFourColComponent_div_17_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r22.type == "name" || item_r22.type == "barcode-text" || item_r22.type == "lot_number" && item_r22.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFourColComponent_div_17_div_4_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r36.type == "name" || item_r36.type == "barcode-text" || item_r36.type == "lot_number" && item_r36.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFourColComponent_div_17_div_5_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r50.type == "name" || item_r50.type == "barcode-text" || item_r50.type == "lot_number" && item_r50.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFourColComponent_div_19_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r69.type == "name" || item_r69.type == "barcode-text" || item_r69.type == "lot_number" && item_r69.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFourColComponent_div_19_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r83.type == "name" || item_r83.type == "barcode-text" || item_r83.type == "lot_number" && item_r83.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFourColComponent_div_19_div_4_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r97.type == "name" || item_r97.type == "barcode-text" || item_r97.type == "lot_number" && item_r97.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintFourColComponent_div_19_div_5_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r111.type == "name" || item_r111.type == "barcode-text" || item_r111.type == "lot_number" && item_r111.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
/***/ 29863:
/*!************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-lots/print-one-col/print-one-col.component.ts ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function PrintOneColComponent_div_17_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", pro_r5.type == "name" || pro_r5.type == "barcode-text" || pro_r5.type == "lot_number" && pro_r5.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintOneColComponent_div_19_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", pro_r21.type == "name" || pro_r21.type == "barcode-text" || pro_r21.type == "lot_number" && pro_r21.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
/***/ 94843:
/*!****************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-lots/print-three-col/print-three-col.component.ts ***!
  \****************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function PrintThreeColComponent_div_17_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r7.type == "name" || item_r7.type == "barcode-text" || item_r7.type == "lot_number" && item_r7.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintThreeColComponent_div_17_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r21.type == "name" || item_r21.type == "barcode-text" || item_r21.type == "lot_number" && item_r21.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintThreeColComponent_div_17_div_4_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r35.type == "name" || item_r35.type == "barcode-text" || item_r35.type == "lot_number" && item_r35.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintThreeColComponent_div_19_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r53.type == "name" || item_r53.type == "barcode-text" || item_r53.type == "lot_number" && item_r53.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintThreeColComponent_div_19_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r67.type == "name" || item_r67.type == "barcode-text" || item_r67.type == "lot_number" && item_r67.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintThreeColComponent_div_19_div_4_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r81.type == "name" || item_r81.type == "barcode-text" || item_r81.type == "lot_number" && item_r81.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
/***/ 37170:
/*!************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-lots/print-two-col/print-two-col.component.ts ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function PrintTwoColComponent_div_17_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", pro_r6.type == "name" || pro_r6.type == "barcode-text" || pro_r6.type == "lot_number" && pro_r6.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintTwoColComponent_div_17_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", pro_r20.type == "name" || pro_r20.type == "barcode-text" || pro_r20.type == "lot_number" && pro_r20.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintTwoColComponent_div_19_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", pro_r37.type == "name" || pro_r37.type == "barcode-text" || pro_r37.type == "lot_number" && pro_r37.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
function PrintTwoColComponent_div_19_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", pro_r51.type == "name" || pro_r51.type == "barcode-text" || pro_r51.type == "lot_number" && pro_r51.status);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
//# sourceMappingURL=src_app_cafe_desktop_menu_management_design_design-barcode_label-lots_label-lots_module_ts.js.map