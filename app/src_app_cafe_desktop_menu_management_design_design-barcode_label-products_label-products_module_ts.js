"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_cafe_desktop_menu_management_design_design-barcode_label-products_label-products_module_ts"],{

/***/ 35512:
/*!**************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-products/detail/detail.component.ts ***!
  \**************************************************************************************************************/
...
class DetailComponent {
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products']);
    }
    updateZindex() {
    ...
    gotoPrintBarcode() {
        ...
        switch (this.col) {
            case 1: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products/print-one-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, price: this.stamp.property[3].value } } });
                break;
            }
            case 2: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products/print-two-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, price: this.stamp.property[3].value } } });
                break;
            }
            case 3: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products/print-three-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, price: this.stamp.property[3].value } } });
                break;
            }
            case 4: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products/print-four-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, price: this.stamp.property[3].value } } });
                break;
            }
            case 5: {
                this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products/print-five-col'], { state: { col: this.col, number: this.number, barcode: this.stamp, formProduct: { name: this.stamp.property[0].value, barcode: this.stamp.property[1].value, price: this.stamp.property[3].value } } });
                break;
            }
            default: {
...
/***/ 30635:
/*!***************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-products/label-products.component.ts ***!
  \***************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class LabelProductsComponent {
    ...
    initForm() {
        this.formAdd = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormGroup({
            ...
            type: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControl(6)
        });
    }
    addBarcode() {
...
/***/ 63670:
/*!************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-products/label-products.module.ts ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _label_products_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./label-products.component */ 30635);
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detail/detail.component */ 35512);
/* harmony import */ var _print_four_col_print_four_col_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./print-four-col/print-four-col.component */ 44575);
/* harmony import */ var _print_five_col_print_five_col_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./print-five-col/print-five-col.component */ 41083);
...
/* harmony import */ var _print_two_col_print_two_col_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./print-two-col/print-two-col.component */ 85964);
/* harmony import */ var _print_three_col_print_three_col_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./print-three-col/print-three-col.component */ 70856);
/* harmony import */ var _print_one_col_print_one_col_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./print-one-col/print-one-col.component */ 10685);
...
const routes = [
    ...
    {
        path: 'print-two-col',
        component: _print_two_col_print_two_col_component__WEBPACK_IMPORTED_MODULE_4__.PrintTwoColComponent
    },
    {
        path: 'print-three-col',
        component: _print_three_col_print_three_col_component__WEBPACK_IMPORTED_MODULE_5__.PrintThreeColComponent
    },
    {
        path: 'print-one-col',
        component: _print_one_col_print_one_col_component__WEBPACK_IMPORTED_MODULE_6__.PrintOneColComponent
    },
    {
        path: 'print-four-col',
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵsetNgModuleScope"](LabelProductsModule, { declarations: [_label_products_component__WEBPACK_IMPORTED_MODULE_0__.LabelProductsComponent,
        ...
        _print_two_col_print_two_col_component__WEBPACK_IMPORTED_MODULE_4__.PrintTwoColComponent,
        _print_three_col_print_three_col_component__WEBPACK_IMPORTED_MODULE_5__.PrintThreeColComponent,
        _print_one_col_print_one_col_component__WEBPACK_IMPORTED_MODULE_6__.PrintOneColComponent,
...
/***/ 41083:
/*!******************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-products/print-five-col/print-five-col.component.ts ***!
  \******************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class PrintFiveColComponent {
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/design/design-label/label-products/detail'], { state: this.stamp.barcode });
    }
    Print() {
        if (this.platform.is("electron"))
            this.printElectron();
...
/***/ 44575:
/*!******************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-products/print-four-col/print-four-col.component.ts ***!
  \******************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 10685:
/*!****************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-products/print-one-col/print-one-col.component.ts ***!
  \****************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 70856:
/*!********************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-products/print-three-col/print-three-col.component.ts ***!
  \********************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 85964:
/*!****************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/design/design-barcode/label-products/print-two-col/print-two-col.component.ts ***!
  \****************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
//# sourceMappingURL=src_app_cafe_desktop_menu_management_design_design-barcode_label-products_label-products_module_ts.js.map