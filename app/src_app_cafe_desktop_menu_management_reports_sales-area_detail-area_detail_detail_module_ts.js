"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_cafe_desktop_menu_management_reports_sales-area_detail-area_detail_detail_module_ts"],{

/***/ 64714:
/*!*************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-area/detail-area/detail/detail-bill/detail-bill.component.ts ***!
  \*************************************************************************************************************************/
...
class DetailBillComponent {
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/report/sales-area/detail-area/detail'], { state: { product: this.dataTrans.product, area: this.dataTrans.area, stateObj: this.dataTrans.stateObj, page2Details: this.dataTrans.page2Details, page3Details: this.dataTrans.page3Details } });
    }
    ...
    ngAfterViewChecked() {
        if (document.querySelector("#detail-report-sales-area") && document.querySelector(".ant-table-thead") && document.querySelector(".detail-report-sales-area-header") && document.querySelector(".ant-table-pagination")) {
            this.heightScroll = document.querySelector("#detail-report-sales-area").clientHeight - document.querySelector(".ant-table-thead").clientHeight
                - document.querySelector(".detail-report-sales-area-header").clientHeight - document.querySelector(".ant-table-pagination").clientHeight - 40 + "px";
        }
...
/***/ 42385:
/*!********************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-area/detail-area/detail/detail.component.ts ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class DetailComponent {
    ...
    /**
     * get dữ liệu báo cáo
     * @param product nhận từ state
     * @example this.getSalesDetail(product)
     */
    getSalesDetail(product) {
        console.log(product);
        if (product.ptype) {
            this.vhComponent.showLoading("", "transparent-loading").then(() => {
                this.vhQueryCafe.getReportSales_Areas_byProduct(this.stateObj.dataReport['startTime'], this.stateObj.dataReport['endTime'], this.area['id_area'], product.id_subproduct ? product.id_subproduct : product.id_product, this.stateObj.id_branch_report)
                    .then((res) => {
        ...
        if (product.id_payment_card) {
            this.vhComponent.showLoading("", "transparent-loading").then(() => {
                this.vhQueryCafe.getReportSales_Areas_byPaymentCard(this.stateObj.dataReport['startTime'], this.stateObj.dataReport['endTime'], this.area['id_area'], product.id_payment_card, this.stateObj.id_branch_report)
                    .then((res) => {
                    this.details = Object.assign({}, res);
                }).catch(err => console.error(err))
                    .finally(() => this.vhComponent.hideLoading(0));
        ...
        if (product.id_voucher) {
            this.vhComponent.showLoading("", "transparent-loading").then(() => {
                this.vhQueryCafe.getReportSales_Areas_byVoucher(this.stateObj.dataReport['startTime'], this.stateObj.dataReport['endTime'], this.area['id_area'], product.id_voucher, this.stateObj.id_branch_report)
                    .then((res) => {
                    this.details = Object.assign({}, res);
                }).catch(err => console.error(err))
                    .finally(() => this.vhComponent.hideLoading(0));
    ...
    goToDetail(item) {
        ...
        // setTimeout(() => this.router.navigate(['/cafe/dashboard/management/report/sales-area/detail-area/detail/detail-bill'], { state: { id_bill: item['id_bill'], product: this.product, area: this.area, stateObj: this.stateObj, page2Details: this.page2Detail, page3Details: this.details } }), 100)
    }
    format_date(date) {
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/report/sales-area/detail-area'], { state: { area: this.area, stateObj: this.stateObj, page2Detail: this.page2Detail } });
    }
}
...
DetailComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: DetailComponent, selectors: [["app-detail"]], decls: 82, vars: 62, consts: [["nz-row", "", 1, "row-back", "small-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], [1, "height-layout"], ["nz-row", "", 1, "height-header"], ["nz-col", "", "nzSpan", "21", 1, "title"], ["nz-col", "", "nzSpan", "3", 1, "title", "center-all-content"], ["nz-button", "", "nzType", "default", 1, "btn-data", 3, "click"], ["nz-icon", "", "nzType", "download", "nzTheme", "outline"], [2, "padding-top", "20px"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzPageSize", "nzPageSizeOptions", "nzScroll", "nzNoResult", "nzData"], ["detailData", ""], ["nzLeft", "", "nzWidth", "120px"], ["nzLeft", "", "nzWidth", "200px"], ["nzWidth", "80px"], ["nzWidth", "100px", "nzAlign", "center"], ["nzWidth", "100px"], ["nzWidth", "80px", "nzAlign", "center"], ["nzWidth", "200px", "nzAlign", "right", 4, "ngIf"], ["nzWidth", "200px", "nzAlign", "right"], ["nzWidth", "150px"], ["nzLeft", ""], ["nzLeft", "", 2, "color", "var(--ion-color-vh-green)"], ["nzAlign", "center", 2, "color", "var(--ion-color-vh-green)"], ["nzAlign", "right", 2, "color", "var(--ion-color-vh-green)", 3, "ngStyle"], ["nzAlign", "right", 2, "color", "var(--ion-color-vh-green)"], ["style", "cursor: pointer;", 3, "click", 4, "ngFor", "ngForOf"], [2, "cursor", "pointer", 3, "click"], ["nzAlign", "center"], ["nzAlign", "right"], ["nzAlign", "right", 3, "ngStyle"]], template: function DetailComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 0);
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](14, 27, "Download"), "");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpropertyInterpolate"]("nzNoResult", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](18, 29, "No data"));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("nzPageSize", 20)("nzPageSizeOptions", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpureFunction0"](56, _c1))("nzScroll", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpureFunction2"](57, _c2, ctx.widthScroll, ctx.heightScroll))("nzData", ctx.details.docs);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](7);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](24, 31, "Invoice code"));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](28, 33, "Date"));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](32, 35, "Products"));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](36, 37, "Unit"), " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](40, 39, "Quantity"), " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](44, 41, "Selling price"), " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](48, 43, "Tax"), " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", ctx.reportConfig.sales_btax);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](53, 45, "Sales after tax"), " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](57, 47, "Employee"), " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](61, 49, "Customer"), " ");
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](7);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](68, 51, "Total"));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind2"](72, 53, ctx.details["quantity"], "1.0-2"));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngStyle", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpureFunction1"](60, _c0, !ctx.reportConfig.sales_btax ? "none" : ""));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
...
/***/ 23925:
/*!*****************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-area/detail-area/detail/detail.module.ts ***!
  \*****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common */ 54364);
/* harmony import */ var _detail_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.component */ 42385);
/* harmony import */ var _detail_bill_detail_bill_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detail-bill/detail-bill.component */ 64714);
...
//# sourceMappingURL=src_app_cafe_desktop_menu_management_reports_sales-area_detail-area_detail_detail_module_ts.js.map