"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_cafe_desktop_menu_management_reports_sales-customer_detail-customer_detail_detail_module_ts"],{

/***/ 77636:
/*!*********************************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-customer/detail-customer/detail/detail-bill/detail-bill.component.ts ***!
  \*********************************************************************************************************************************/
...
class DetailBillComponent {
    ...
    init(invoice = null, invoiceDetail = null) {
        this.invoice = new src_app_cafe_interface_vh_order_invoice__WEBPACK_IMPORTED_MODULE_0__.VhOrderInvoices(invoice, invoiceDetail);
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/report/sales-customer/detail-customer/detail'], { state: { product: this.dataTrans.product, customer: this.dataTrans.customer, stateObj: this.dataTrans.stateObj, page2Details: this.dataTrans.page2Details, page3Details: this.dataTrans.page3Details } });
    }
...
/***/ 19630:
/*!****************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-customer/detail-customer/detail/detail.component.ts ***!
  \****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class DetailComponent {
    ...
    getSalesDetail(product) {
        if (product.ptype) {
            this.vhComponent.showLoading("", "transparent-loading").then(() => {
                this.vhQueryCafe.getReportSales_Customers_byProduct(this.stateObj.dataReport['startTime'], this.stateObj.dataReport['endTime'], product.id_customer, product.id_subproduct ? product.id_subproduct : product.id_product, this.stateObj.id_branch_report)
                    .then((res) => {
        ...
        if (product.id_payment_card) {
            this.vhComponent.showLoading("", "transparent-loading").then(() => {
                this.vhQueryCafe.getReportSales_Customers_byPaymentCard(this.stateObj.dataReport['startTime'], this.stateObj.dataReport['endTime'], product.id_customer, product.id_payment_card, this.stateObj.id_branch_report)
                    .then((res) => {
                    this.details = Object.assign({}, res);
                }).catch(err => console.error(err))
                    .finally(() => this.vhComponent.hideLoading(0));
        ...
        if (product.id_voucher) {
            this.vhComponent.showLoading("", "transparent-loading").then(() => {
                this.vhQueryCafe.getReportSales_Customers_byVoucher(this.stateObj.dataReport['startTime'], this.stateObj.dataReport['endTime'], product.id_customer, product.id_voucher, this.stateObj.id_branch_report)
                    .then((res) => {
                    this.details = Object.assign({}, res);
                }).catch(err => console.error(err))
                    .finally(() => this.vhComponent.hideLoading(0));
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/report/sales-customer/detail-customer'], { state: { customer: this.customer, stateObj: this.stateObj, page2Detail: this.page2Detail } });
    }
}
...
/***/ 58402:
/*!*************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-customer/detail-customer/detail/detail.module.ts ***!
  \*************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _detail_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.component */ 19630);
/* harmony import */ var _detail_bill_detail_bill_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detail-bill/detail-bill.component */ 77636);
...
//# sourceMappingURL=src_app_cafe_desktop_menu_management_reports_sales-customer_detail-customer_detail_detail_module_ts.js.map