"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_cafe_desktop_menu_management_reports_sales-dishes_detail_detail_module_ts"],{

/***/ 43457:
/*!***************************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-dishes/detail/detail-bill/detail-bill.component.ts ***!
  \***************************************************************************************************************/
...
class DetailBillComponent {
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/report/sales-dishes/detail'], { state: { product: this.dataTrans.product, area: this.dataTrans.area, stateObj: this.dataTrans.stateObj, details: this.dataTrans.details } });
    }
    ...
    ngAfterViewChecked() {
        if (document.querySelector("#detail-report-sales-product") && document.querySelector(".ant-table-thead") && document.querySelector(".detail-report-sales-product-header") && document.querySelector(".ant-table-pagination")) {
            this.heightScroll = document.querySelector("#detail-report-sales-product").clientHeight - document.querySelector(".ant-table-thead").clientHeight
                - document.querySelector(".detail-report-sales-product-header").clientHeight - document.querySelector(".ant-table-pagination").clientHeight - 40 + "px";
        }
...
/***/ 12835:
/*!**********************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-dishes/detail/detail.component.ts ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class DetailComponent {
    ...
    export() {
        ...
        for (let _rows of this.details['docs']) {
            ...
            item[this.languageService.translate("Products")] = _rows.name;
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/report/sales-dishes'], { state: { stateObj: this.stateObj } });
    }
}
...
DetailComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineComponent"]({ type: DetailComponent, selectors: [["app-detail"]], decls: 82, vars: 62, consts: [["nz-row", "", 1, "row-back", "small-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], [1, "height-layout"], ["nz-row", "", 1, "height-header"], ["nz-col", "", "nzSpan", "21", 1, "title"], ["nz-col", "", "nzSpan", "3", 1, "title", "center-all-content"], ["nz-button", "", "nzType", "default", 1, "btn-data", 3, "click"], ["nz-icon", "", "nzType", "download", "nzTheme", "outline"], [2, "padding-top", "20px"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzPageSize", "nzPageSizeOptions", "nzScroll", "nzNoResult", "nzData"], ["detailData", ""], ["nzLeft", "", "nzWidth", "120px"], ["nzLeft", "", "nzWidth", "200px"], ["nzWidth", "80px"], ["nzWidth", "100px", "nzAlign", "center"], ["nzWidth", "100px"], ["nzWidth", "80px", "nzAlign", "center"], ["nzWidth", "200px", "nzAlign", "right", 4, "ngIf"], ["nzWidth", "200px", "nzAlign", "right"], ["nzWidth", "150px"], ["nzLeft", ""], ["nzLeft", "", 2, "color", "var(--ion-color-vh-green)"], ["nzAlign", "center", 2, "color", "var(--ion-color-vh-green)"], ["nzAlign", "right", 2, "color", "var(--ion-color-vh-green)", 3, "ngStyle"], ["nzAlign", "right", 2, "color", "var(--ion-color-vh-green)"], ["style", "cursor: pointer;", 3, "click", 4, "ngFor", "ngForOf"], [2, "cursor", "pointer", 3, "click"], ["nzAlign", "center"], ["nzAlign", "right"], ["nzAlign", "right", 3, "ngStyle"]], template: function DetailComponent_Template(rf, ctx) { if (rf & 1) {
...
/***/ 91072:
/*!*******************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/reports/sales-dishes/detail/detail.module.ts ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _detail_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.component */ 12835);
/* harmony import */ var _detail_bill_detail_bill_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detail-bill/detail-bill.component */ 43457);
...
//# sourceMappingURL=src_app_cafe_desktop_menu_management_reports_sales-dishes_detail_detail_module_ts.js.map