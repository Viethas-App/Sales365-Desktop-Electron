"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_cafe_desktop_menu_management_sales-program_coupons_design_design_module_ts"],{

/***/ 83218:
/*!***********************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/sales-program/coupons/design/design.component.ts ***!
  \***********************************************************************************************/
...
class DesignComponent {
    ...
    ngOnInit() {
        // this.vhQuery.getDocs("barcode_designs").then((response:any)=>{
        //   for(let i in response){
        //     this.vhQuery.deleteDoc("barcode_designs",response[i]._id)
        //   }
        // })
        this.getData();
        this.initForm();
        ...
        this.vhComponent.showLoading('').then(() => {
            this.vhQuery.addDoc("barcode_designs", Object.assign(Object.assign({}, this.formAdd.value), { id_branch: this.vhQueryCafe.getDefaultBranch()._id, property: [
                    ...
                    },
                    {
                        ...
                        "text_align": "end",
                        "height": 15,
                        "x": 283.19097900390625,
                        "font_weight": "bold",
                        "width": 60,
                        "index": 2,
                        "y": 124.29165649414062,
                        "status": true,
                        "type": "barcode"
                    },
                    {
    ...
    gotoEdit(item) {
        this.router.navigate(['/cafe/dashboard/management/sales-program/coupons/design/detail'], { state: item });
        // switch(item.col){
        //   case 2:{
...
/***/ 41383:
/*!********************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/sales-program/coupons/design/design.module.ts ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _design_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./design.component */ 83218);
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detail/detail.component */ 65427);
/* harmony import */ var _detail_print_print_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail/print/print.component */ 7227);
...
/***/ 65427:
/*!******************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/sales-program/coupons/design/detail/detail.component.ts ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class DetailComponent {
    ...
    onUpload(e) {
        ...
        this.vhImage.getThumbnailFromDesktop(file, this.stamp.width * 3.78, this.stamp.height * 3.78, "design-coupons", this.stamp['img'] || null).then(photoURL => {
    ...
    gotoPrintBarcode() {
        ...
        this.router.navigate(['/cafe/dashboard/management/sales-program/coupons/design/detail/print'], { state: { number: this.number, barcode: this.stamp } });
    }
}
...
/***/ 7227:
/*!***********************************************************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/management/sales-program/coupons/design/detail/print/print.component.ts ***!
  \***********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class PrintComponent {
    ...
    goBack() {
        this.router.navigate(['/cafe/dashboard/management/sales-program/coupons/design/detail'], { state: this.stamp.barcode });
    }
    printBrowser() {
...
//# sourceMappingURL=src_app_cafe_desktop_menu_management_sales-program_coupons_design_design_module_ts.js.map