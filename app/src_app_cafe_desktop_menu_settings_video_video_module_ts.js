"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_cafe_desktop_menu_settings_video_video_module_ts"],{

/***/ 58925:
/*!*********************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/settings/video/video.component.ts ***!
  \*********************************************************************/
...
function VideoComponent_div_7_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("src", video_r1, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeResourceUrl"]);
} }
        ...
        this.vhAuth.getManualVideos('desktop')
            ...
            if (!manualVideos.empty) {
                manualVideos.docs.forEach(video => {
                    this.videos.push(this.vhAlgorithm.vhYoutubeLink(video.data().ytid));
                });
            }
        }, error => {
...
VideoComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: VideoComponent, selectors: [["app-video"]], decls: 8, vars: 4, consts: [["nz-row", ""], ["nz-col", "", "nzSpan", "21", 1, "title"], ["nz-row", "", 1, "body"], ["nz-col", "", "nzSpan", "8", "style", "padding:8px", 4, "ngFor", "ngForOf"], ["nz-col", "", "nzSpan", "8", 2, "padding", "8px"], ["width", "100%", "height", "250", "frameborder", "0", "allow", "autoplay; encrypted-media", "allowfullscreen", "", 3, "src"]], template: function VideoComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](7, VideoComponent_div_7_Template, 3, 1, "div", 3);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
/***/ 13797:
/*!******************************************************************!*\
  !*** ./src/app/cafe/desktop/menu/settings/video/video.module.ts ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _video_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./video.component */ 58925);
...
//# sourceMappingURL=src_app_cafe_desktop_menu_settings_video_video_module_ts.js.map