"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_lazada_auto-sale_price-comparison_price-comparison_module_ts"],{

/***/ 27039:
/*!*******************************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-comparison/edit/choose-product/choose-product.component.ts ***!
  \*******************************************************************************************************************************/
...
function ChooseProductComponent_ng_container_2_div_13_tr_15_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"]("(", item_r11.SellerSku, ")");
} }
function ChooseProductComponent_ng_container_2_div_13_tr_15_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", item_r11.SellerSku);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
...
class ChooseProductComponent {
    ...
    /**
     * get sản phẩm trên sàn của lazada. kiem tra nếu chưa trùng skuId thì push vô mảng
     */
    syncProductLazada() {
        this.listProduct = [];
        ...
        for (let item of this.listLocalProduct) {
            let value = {
                item_id: item.item_id, name: item.attributes.name, links: [{ href: '', price: null, seller: null, status: null }]
            };
            item.skus.forEach(element => {
                if ((this.listProductShow.findIndex(i => i.SkuId == element.SkuId) == -1))
                    this.listProduct.push(Object.assign(Object.assign({}, value), { SkuId: element.SkuId, SellerSku: element.SellerSku, status: false, price: element.special_price ? element.special_price : element.price, editPrice: 0, minPrice: element.special_price ? element.special_price : element.price, color_family: element.color_family ? element.color_family : '' }));
            });
        }
...
/***/ 55209:
/*!******************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-comparison/edit/edit.component.ts ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _choose_product_choose_product_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./choose-product/choose-product.component */ 27039);
...
function EditComponent_div_25_ng_container_26_span_9_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"]("(", item_r7.SellerSku, ")");
} }
function EditComponent_div_25_ng_container_26_ng_container_28_tr_1_Template(rf, ctx) { if (rf & 1) {
...
function EditComponent_div_25_ng_container_26_ng_container_28_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](1, EditComponent_div_25_ng_container_26_ng_container_28_tr_1_Template, 9, 7, "tr", 40);
...
function EditComponent_div_25_ng_container_26_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](9, EditComponent_div_25_ng_container_26_span_9_Template, 2, 1, "span", 29);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](10, "i", 30);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](28, EditComponent_div_25_ng_container_26_ng_container_28_Template, 2, 2, "ng-container", 37);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementContainerEnd"]();
} if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", item_r7.SellerSku);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
...
function EditComponent_div_25_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](26, EditComponent_div_25_ng_container_26_Template, 29, 25, "ng-container", 25);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
...
class EditComponent {
    ...
    goBack() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/lazada/auto-sale/price-compare']);
    }
    searchLazada(value) {
        if (value.length) {
            let val = this.vhAlgorithm.changeAlias(value.trim().toLowerCase());
    ...
    removeProduct(value) {
        this.listProductShow = this.listProductShow.filter(item => item.item_id != value.item_id || item.SkuId != value.SkuId);
    }
    save() {
        let productlist = this.listProductShow.map(item => {
            return {
                item_id: item.item_id, name: item.name, links: item.links.filter(item => item.href.toString().length), editPrice: parseFloat(item.editPrice), minPrice: parseFloat(item.minPrice),
                price: item.price, SkuId: item.SkuId, color_family: item.color_family
            };
        });
    ...
    /**sự kiện ẩn drawer khi chọn sản phẩm*/
    ...
    /**tạo giá trị ban đầu khi thêm link */
    addNewLink(item) {
    ...
    /**
     * kiểm tra giá cập nhật phải nhỏ hơn giá trên sàn
     * @param item sản phẩm
     * @param event giá trị cập nhật
     */
    checkEditPrice(item, event) {
        item.editPrice = event.toString().replaceAll(',', '');
    ...
    /**
     * kiểm tra giá nhỏ nhất phải < 1000
     * @param item  sản phẩm
     * @param event giá trị cập nhật
     */
...
/***/ 91930:
/*!*************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-comparison/price-comparison.component.ts ***!
  \*************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class PriceComparisonComponent {
    ...
    ngOnInit() {
        this.vhComponent.showLoading('').then(() => {
            this.vhQuery.getDocsByFields("ecommerce_price_comparings", { type: { $eq: "lazada" }, id_branch: { $eq: this.vhQuerySales.getDefaultBranch()._id } })
                .then((response) => {
    ...
    gotoEdit(item) {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/lazada/auto-sale/price-compare/edit'], { state: item });
    }
    addPriceList() {
        this.nzModalService.confirm({
            ...
            nzOnOk: () => {
                this.vhComponent.showLoading('').then(() => {
                    this.vhQuery.addDoc("ecommerce_price_comparings", { name: this.price_compare_name, type: 'lazada', status: true, id_branch: this.vhQuerySales.getDefaultBranch()._id, productlist: [] })
                        .then((response) => {
                        this.vhComponent.hideLoading(0);
            ...
            nzOnCancel: () => {
                this.vhComponent.showLoading('').then(() => {
                    this.vhQuery.addDoc("ecommerce_price_comparings", { name: this.price_compare_name, type: 'lazada', status: false, productlist: [] })
                        .then((response) => {
                        this.vhComponent.hideLoading(0);
                        this.listProductComapares.push(response);
                        this.showModalAdd = false;
...
/***/ 97124:
/*!**********************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-comparison/price-comparison.module.ts ***!
  \**********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _edit_choose_product_choose_product_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./edit/choose-product/choose-product.component */ 27039);
...
/* harmony import */ var _price_comparison_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./price-comparison.component */ 91930);
/* harmony import */ var _edit_edit_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit/edit.component */ 55209);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_lazada_auto-sale_price-comparison_price-comparison_module_ts.js.map