"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_lazada_auto-sale_price-list_price-list_module_ts"],{

/***/ 13372:
/*!*************************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-list/edit/choose-product/choose-product.component.ts ***!
  \*************************************************************************************************************************/
...
function ChooseProductComponent_ng_container_2_div_14_tr_21_span_5_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"]("(", item_r14.SellerSku, ")");
} }
function ChooseProductComponent_ng_container_2_div_14_tr_21_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](10, "input", 24, 25);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](13, "td", 23);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](14, "input", 24, 26);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵproperty"]("ngIf", item_r14.SellerSku);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
...
function ChooseProductComponent_ng_container_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpropertyInterpolate"]("nzPlaceHolder", _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipeBind1"](4, 9, "Select shop on Lazada"));
...
class ChooseProductComponent {
    ...
    ngOnChanges({ listProductShow }) {
        this.syncProductLazada();
    }
    /**Chọn shop và lọc sản phẩm theo shop đó */
    changeShop(id) {
        this.listProduct = [];
        this.listSubProduct = [];
        this.infoShop = this.vhQuerySales.getlocalShopListLazada().find(item => item._id == id);
        this.syncProductLazada();
    }
    /**
    ...
    syncProductLazada() {
        ...
        if (this.id_shop_selected.toString().length < 5 && this.id_shop_selected) {
            for (let item of this.list_price_list[this.id_shop_selected].productlist) {
                if ((this.listProductShow.findIndex(i => i.SkuId == item.SkuId) == -1))
                    this.listProduct.push(Object.assign(Object.assign({}, item), { status: false }));
            }
        }
        else {
            this.listLocalProduct = this.vhQuerySales.getlocalProductListLazada(this.infoShop['_id']);
            for (let item of this.listLocalProduct) {
                let value = {
                    item_id: item.item_id, name: item.attributes.name,
                };
                item.skus.forEach(element => {
                    if ((this.listProductShow.findIndex(i => i.SkuId == element.SkuId) == -1))
                        this.listProduct.push(Object.assign(Object.assign({}, value), { SkuId: element.SkuId, status: false, price: element.special_price ? element.special_price : element.price, color_family: element.color_family ? element.color_family : '', SellerSku: element.SellerSku, newPrice1: element.special_price ? element.special_price : element.price, newPrice2: element.special_price ? element.special_price : element.price }));
                });
            }
        }
...
/***/ 21825:
/*!*******************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-list/edit/choose-time/choose-time.component.ts ***!
  \*******************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _modal_edit_operating_time_modal_edit_operating_time_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modal-edit-operating-time/modal-edit-operating-time.component */ 68255);
...
/***/ 99778:
/*!************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-list/edit/edit.component.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _choose_product_choose_product_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./choose-product/choose-product.component */ 13372);
/* harmony import */ var _choose_time_choose_time_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./choose-time/choose-time.component */ 21825);
...
function EditComponent_div_29_tr_21_span_6_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate1"]("(", item_r7.SellerSku, ")");
} }
function EditComponent_div_29_tr_21_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngIf", item_r7.SellerSku);
...
function EditComponent_ng_template_30_p_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](2, 1, "You have not associated with the product in the shop or have not created the product on the Sales Viethas"), " ");
} }
...
class EditComponent {
    ...
    goBack() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/lazada/auto-sale/price-list']);
    }
    searchLazada(value) {
        if (value.length) {
            let val = this.vhAlgorithm.changeAlias(value.trim().toLowerCase());
    ...
    removeProduct(value) {
        this.listProductShow = this.listProductShow.filter(item => item.id != value.id || item.SkuId != value.SkuId);
    }
    /**
     * lưu lên database
     */
    save() {
        ...
        let productlist = this.listProductShow.map(item => {
            return {
                item_id: item.item_id, name: item.name, SkuId: item.SkuId, SellerSku: item.SellerSku,
                newPrice1: parseFloat(item.newPrice1), newPrice2: parseFloat(item.newPrice2),
                price: item.price, color_family: item.color_family ? item.color_family : ''
            };
        });
...
EditComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: EditComponent, selectors: [["app-edit"]], decls: 34, vars: 29, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["id", "by-product-sendo-price"], ["nz-row", "", "nzGutter", "8", 1, "by-product-sendo-price-header"], ["nz-col", "", "nzSpan", "6", 1, "title"], ["nz-col", "", "nzSpan", "8", 1, "title", "center-all-content"], [3, "nzSuffix"], ["type", "text", "nz-input", "", 3, "ngModel", "placeholder", "ngModelChange"], ["suffixIconSearch", ""], ["nz-col", "", "nzSpan", "10", 1, "right-all-content"], ["nz-button", "", "nzType", "default", 2, "margin-right", "16px", 3, "click"], ["nz-icon", "", "nzType", "plus", "nzTheme", "outline"], ["nz-button", "", "nzType", "default", 1, "add-button", "center-all-content", 3, "disabled", "click"], ["nz-icon", "", "nzType", "save", "nzTheme", "outline"], ["nz-row", "", "nzGutter", "16", "class", "by-product-sendo-price-body", 4, "ngIf", "ngIfElse"], ["no_data", ""], [3, "showDrawerSelectProduct", "listProductShow", "id_shop", "list_price_list", "hideDrawerSelectProduct"], [3, "showDrawerSelectTime", "priceList", "hideDrawerSelectTime"], ["nz-icon", "", "nzType", "search"], ["nz-row", "", "nzGutter", "16", 1, "by-product-sendo-price-body"], ["nz-col", "", "nzSpan", "24"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzPageSize", "nzPageSizeOptions", "nzScroll", "nzNoResult", "nzData"], ["list_product_show", ""], ["nzWidth", "65%"], ["nzAlign", "right", "nzWidth", "20%"], [4, "ngFor", "ngForOf", "ngForTrackBy"], ["nz-icon", "", "nzType", "close", "nzTheme", "outline", "nz-popconfirm", "", "nzPopconfirmPlacement", "bottomLeft", 2, "font-size", "1.2rem", "color", "red", 3, "nzPopconfirmTitle", "nzOnConfirm"], [2, "margin-left", "16px", 3, "click"], ["style", "color: var(--ion-color-vh-green);", 4, "ngIf"], ["nz-icon", "", "nzType", "copy", "nzTheme", "outline", 3, "click"], ["nzAlign", "right"], ["type", "text", "maxlength", "15", "nz-input", "", 3, "value", "ngClass", "placeholder", "keyup"], ["box", ""], ["box2", ""], [2, "color", "var(--ion-color-vh-green)"], ["nz-row", "", 1, "no-affiliate"], ["nz-col", "", "nzSpan", "24", 1, "text-center"], ["src", "assets/icon/management/ecommerce/no-affiliate-product.svg", "alt", ""], [4, "ngIf"]], template: function EditComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("ngModelChange", function EditComponent_Template_input_ngModelChange_12_listener($event) { return ctx.searchValue = $event; })("ngModelChange", function EditComponent_Template_input_ngModelChange_12_listener($event) { return ctx.searchLazada($event); });
...
/***/ 68255:
/*!***********************************************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-list/edit/modal-edit-operating-time/modal-edit-operating-time.component.ts ***!
  \***********************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ 75804:
/*!*************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-list/price-list.component.ts ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class PriceListComponent {
    ...
    ngOnInit() {
        this.vhComponent.showLoading('').then(() => {
            this.vhQuery.getDocsByFields("ecommerce_price_lists", { type: { $eq: "lazada" }, id_branch: { $eq: this.vhQuerySales.getDefaultBranch()._id } })
                .then((response) => {
    ...
    addPriceList() {
        this.vhComponent.showLoading('').then(() => {
            this.vhQuery.addDoc("ecommerce_price_lists", { name: this.price_list_name, type: 'lazada', status: true, id_branch: this.vhQuerySales.getDefaultBranch()._id, monday: [], tuesday: [], wednesday: [], thursday: [], friday: [], saturday: [], sunday: [] })
                .then((response) => {
                this.vhComponent.hideLoading(0);
    ...
    gotoEdit(item) {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/lazada/auto-sale/price-list/edit'], { state: { price_list: item, list_price_list: this.listPriceLists } });
    }
    updateStatus(item) {
...
/***/ 45768:
/*!**********************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/auto-sale/price-list/price-list.module.ts ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _edit_choose_time_choose_time_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./edit/choose-time/choose-time.component */ 21825);
/* harmony import */ var _edit_modal_edit_operating_time_modal_edit_operating_time_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit/modal-edit-operating-time/modal-edit-operating-time.component */ 68255);
...
/* harmony import */ var _price_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./price-list.component */ 75804);
/* harmony import */ var _edit_edit_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./edit/edit.component */ 99778);
/* harmony import */ var _edit_choose_product_choose_product_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edit/choose-product/choose-product.component */ 13372);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_lazada_auto-sale_price-list_price-list_module_ts.js.map