"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_lazada_update-stock_by-product-app_by-product-app_module_ts"],{

/***/ 41669:
/*!************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/update-stock/by-product-app/by-product-app.component.ts ***!
  \************************************************************************************************************/
...
function ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_tr_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("ngModelChange", function ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_tr_1_Template_nz_input_number_ngModelChange_26_listener($event) { const restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r24); const sku_r14 = restoredCtx.$implicit; const product_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]().$implicit; const ctx_r22 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](3); return ctx_r22.checkStock(product_r12, $event, sku_r14); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"]("", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](8, 14, "Shop SKU"), ": ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](sku_r14.ShopSku);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"]("", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](13, 16, "Seller SKU"), ": ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](sku_r14.SellerSku);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](18, 18, ctx_r13.renderStatusProduct(sku_r14.Status)));
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind2"](21, 20, sku_r14.dateUpdateStock, "dd/MM/YYYY HH:mm"));
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"]("", sku_r14.quantity, " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpropertyInterpolate"]("nzPlaceHolder", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](27, 23, "Enter quantity"));
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("nzMax", 9999999999)("nzMin", 0)("nzStep", 1)("ngModel", sku_r14.newQuantity);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵproperty"]("ngIf", sku_r14.newQuantity >= 0);
} }
function ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](1, ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_tr_1_Template, 29, 25, "tr", 31);
    ...
    */
    changeShop(id) {
        ...
        this.listProductApp = localProducts.map(item => {
            ...
            if (item.lazadas && item.lazadas.length) { //filter những sp lazada thuộc id lazada đã chọn
                item.lazadas = [...item.lazadas.filter(prod => prod.id_shop == id)];
            }
            return item;
        });
    ...
    /**
     * trờ về trang quản lý cập nhật tồn kho
     * @example this.goBack()
     */
    goBack() {
    ...
    /**
     * trả về tên trang thái của đơn
     * @param status
     * @returns string
     * @example let status = this.renderStatusProduct('active')
     */
     ...
     * @example this.updateQuantity(product, productApp, sku)
    */
    updateQuantity(product, productApp, sku) {
        sku.loading = true;
        this.vhQuerySales.updateProductByXMLLazada(this.renderFormUpdate(product, sku), this.infoShop['access_token']).then((res) => {
            if (res) {
                this.vhQuerySales.getProductDetailLazada([product.item_id], this.infoShop['access_token'], this.infoShop['_id']).then((productLazada) => {
                    if (this.checkQuantityAfterUpdate(product, productLazada[0], sku)) {
                        sku['dateUpdateStock'] = new Date().toISOString();
                        this.vhQuerySales.updateMergeLazadasProduct_skus(productApp['_id'], product['item_id'], sku.SkuId, { dateUpdateStock: sku['dateUpdateStock'] }, this.infoShop['_id']).then((result) => {
                            sku.loading = false;
     ...
     */
    checkStock(product, event, sku) {
        if (typeof event == 'string')
            delete sku.newQuantity;
        else
            sku.newQuantity = event;
    }
    /**Kiểm tra xem sau khi update thì quantity có bằng với quantity khi update hay không
     * @example this.checkQuantityAfterUpdate(product, productLazada, sku)
     */
    checkQuantityAfterUpdate(product, productLazada, sku) {
        let prod = productLazada.skus.find(item => item.SkuId == sku.SkuId);
        if (prod && prod.quantity == sku.newQuantity) {
            sku.quantity = prod.quantity;
            delete sku.newQuantity;
            return true;
        }
        else
    ...
    <Product>
      <Skus>
        <Sku>
          ...
          <quantity>${sku.newQuantity}</quantity>
        </Sku>
      </Skus>
    </Product>
  </Request>`;
...
ByProductAppComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: ByProductAppComponent, selectors: [["app-by-product-app"]], decls: 57, vars: 45, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["id", "by-product-app-stock"], ["nz-row", "", "nzGutter", "8", 1, "by-product-app-stock-header"], ["nz-col", "", "nzSpan", "4", 1, "title"], ["nz-col", "", "nzSpan", "6"], [1, "color-green"], ["nz-col", "", "nzSpan", "6", 1, "title", "center-all-content"], [3, "nzSuffix"], ["type", "text", "nz-input", "", 3, "ngModel", "placeholder", "ngModelChange"], ["suffixIconSearch", ""], ["nz-col", "", "nzSpan", "8", 1, "right-all-content"], ["nz-row", "", "nzGutter", "16", 1, "affiliate-product-body"], ["nz-col", "", "nzSpan", "24"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzPageSize", "nzPageSizeOptions", "nzScroll", "nzNoResult", "nzData"], ["list_product_show", ""], ["nzWidth", "3%"], ["nzWidth", "10%"], ["nzWidth", "25%"], ["nzWidth", "13%"], ["nzAlign", "left", "nzWidth", "12%"], ["nzAlign", "right", "nzWidth", "10%"], ["nzWidth", "12%"], [4, "ngFor", "ngForOf", "ngForTrackBy"], ["nz-icon", "", "nzType", "search"], ["class", "icon-expand", "nz-icon", "", "nzTheme", "outline", 3, "nzType", "click", 4, "ngIf"], ["onerror", "this.src='./assets/icon/management/image_default.svg'", "width", "40px", "height", "40px", 3, "ngStyle", "src"], ["nzAlign", "right"], ["nzAlign", "center"], [4, "ngIf"], ["nz-icon", "", "nzTheme", "outline", 1, "icon-expand", 3, "nzType", "click"], [4, "ngFor", "ngForOf"], [2, "padding-left", "24px"], [2, "margin", "0"], [1, "sub-prod-update"], [3, "nzPlaceHolder", "nzMax", "nzMin", "nzStep", "ngModel", "ngModelChange"], ["nz-tooltip", "", "class", "btn-update", "nz-button", "", "nzShape", "circle", 3, "nzLoading", "nzTooltipTitle", "nzTooltipColor", "click", 4, "ngIf"], ["nz-tooltip", "", "nz-button", "", "nzShape", "circle", 1, "btn-update", 3, "nzLoading", "nzTooltipTitle", "nzTooltipColor", "click"], ["nz-icon", "", "nzType", "upload", "nzTheme", "outline"]], template: function ByProductAppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](42, 34, "Status on Lazada"));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
...
/***/ 70069:
/*!*********************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/lazada/update-stock/by-product-app/by-product-app.module.ts ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _by_product_app_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./by-product-app.component */ 41669);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_lazada_update-stock_by-product-app_by-product-app_module_ts.js.map