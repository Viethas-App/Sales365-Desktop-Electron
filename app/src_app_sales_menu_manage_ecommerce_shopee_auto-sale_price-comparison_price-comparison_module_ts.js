"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_shopee_auto-sale_price-comparison_price-comparison_module_ts"],{

/***/ 57880:
/*!*******************************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/shopee/auto-sale/price-comparison/edit/choose-product/choose-product.component.ts ***!
  \*******************************************************************************************************************************/
...
/***/ 467:
/*!******************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/shopee/auto-sale/price-comparison/edit/edit.component.ts ***!
  \******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _choose_product_choose_product_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./choose-product/choose-product.component */ 57880);
...
/***/ 30998:
/*!*************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/shopee/auto-sale/price-comparison/price-comparison.component.ts ***!
  \*************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class PriceComparisonComponent {
    ...
    ngOnInit() {
        this.vhComponent.showLoading('').then(() => {
            this.vhQuery.getDocsByFields("ecommerce_price_comparings", { type: { $eq: "shopee" }, id_branch: { $eq: this.vhQuerySales.getDefaultBranch()._id } })
                .then((response) => {
    ...
    gotoEdit(item) {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/shopee/auto-sale/price-compare/edit'], { state: item });
    }
    addPriceList() {
        this.nzModalService.confirm({
            ...
            nzOnOk: () => {
                this.vhComponent.showLoading('').then(() => {
                    this.vhQuery.addDoc("ecommerce_price_comparings", { name: this.price_compare_name, type: 'shopee', status: true, id_branch: this.vhQuerySales.getDefaultBranch()._id, productlist: [] })
                        .then((response) => {
                        this.vhComponent.hideLoading(0);
            ...
            nzOnCancel: () => {
                this.vhComponent.showLoading('').then(() => {
                    this.vhQuery.addDoc("ecommerce_price_comparings", { name: this.price_compare_name, type: 'shopee', status: false, productlist: [] })
                        .then((response) => {
                        this.vhComponent.hideLoading(0);
                        this.listProductComapares.push(response);
                        this.showModalAdd = false;
...
/***/ 36720:
/*!**********************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/shopee/auto-sale/price-comparison/price-comparison.module.ts ***!
  \**********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _edit_choose_product_choose_product_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./edit/choose-product/choose-product.component */ 57880);
...
/* harmony import */ var _price_comparison_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./price-comparison.component */ 30998);
/* harmony import */ var _edit_edit_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit/edit.component */ 467);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_shopee_auto-sale_price-comparison_price-comparison_module_ts.js.map