"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_shopee_e-invoice-sales365_e-invoice-sales365_module_ts"],{

/***/ 65658:
/*!*******************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/shopee/e-invoice-sales365/e-invoice-sales365.component.ts ***!
  \*******************************************************************************************************/
  ...
  sendCQT(invoice) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (this.currentBranch.einvoices.length && this.currentBranch.einvoices.length == 1) {
        ...
        this.billService.changeBill_byLocal_toInvoice_byMinvoice(invoice._id, this.currentBranch.einvoices[0].invoiceSeries[0], 'SHOPEE', this.infoShop).then(rsp => {
          if (rsp.vcode == 0) {
  ...
  sendCQTManual(invoice) {
    ...
    if (currentBranch.einvoices.length && currentBranch.einvoices.length == 1) {
      ...
      if (currentBranch.einvoices[0].invoice_provider == 'M-invoice') {
        ...
        this.billService.changeBill_byLocal_toInvoice_byMinvoice(invoice._id, currentBranch.einvoices[0].invoiceSeries[0], 'SHOPEE', this.infoShop).then(rsp => {
          if (rsp.vcode == 0) {
...
/***/ 80925:
/*!****************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/shopee/e-invoice-sales365/e-invoice-sales365.module.ts ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _e_invoice_sales365_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./e-invoice-sales365.component */ 65658);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_shopee_e-invoice-sales365_e-invoice-sales365_module_ts.js.map