"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_shopee_update-selling-price_update-selling-price_module_ts"],{

/***/ 35673:
/*!***********************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/shopee/update-selling-price/update-selling-price.component.ts ***!
  \***********************************************************************************************************/
...
class UpdateSellingPriceComponent {
    ...
    gotobyProductApp() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/shopee/update-selling-price/by-product-app']);
    }
    gotobyProductShopee() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/shopee/update-selling-price/by-product-shopee']);
    }
}
...
UpdateSellingPriceComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UpdateSellingPriceComponent, selectors: [["app-update-selling-price"]], decls: 31, vars: 12, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["nz-row", ""], ["nz-col", "", "nzSpan", "24", 1, "title"], ["nz-row", "", 1, "cus-row"], ["nz-col", "", "nzSpan", "6", 1, "center-all-content", "item-cus"], [1, "ng-item", "center-all-content", 3, "click"], ["nz-col", "", "nzSpan", "24", 1, "center-all-content"], ["src", "assets/icon/management/ecommerce/by-product-app.svg"], [1, "center-text", "medium-size"], ["src", "assets/icon/management/ecommerce/by-product-sendo.svg"]], template: function UpdateSellingPriceComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UpdateSellingPriceComponent_Template_div_click_22_listener() { return ctx.gotobyProductShopee(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](30, 10, "By product on Shopee"));
...
/***/ 18834:
/*!********************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/shopee/update-selling-price/update-selling-price.module.ts ***!
  \********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _update_selling_price_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./update-selling-price.component */ 35673);
...
const routes = [
    ...
    {
        path: 'by-product-app',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_sales_menu_manage_ecommerce_shopee_update-selling-price_by-product-app_by-product-app-76ec6e").then(__webpack_require__.bind(__webpack_require__, /*! ./by-product-app/by-product-app.module */ 62314)).then(m => m.ByProductAppModule)
    },
    {
        path: 'by-product-shopee',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_sales_menu_manage_ecommerce_shopee_update-selling-price_by-product-shopee_by-product--d324b1").then(__webpack_require__.bind(__webpack_require__, /*! ./by-product-shopee/by-product-shopee.module */ 83809)).then(m => m.ByProductShopeeModule)
    },
];
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_shopee_update-selling-price_update-selling-price_module_ts.js.map