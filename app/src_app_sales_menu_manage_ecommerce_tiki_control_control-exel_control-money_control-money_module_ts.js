"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_tiki_control_control-exel_control-money_control-money_module_ts"],{

/***/ 29719:
/*!****************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiki/control/control-exel/control-money/control-money.component.ts ***!
  \****************************************************************************************************************/
...
function ControlMoneyComponent_ng_container_73_tr_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](7, "i", 35);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function ControlMoneyComponent_ng_container_73_tr_1_Template_i_click_7_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r14); const form_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().$implicit; const ctx_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); $event.stopPropagation(); return ctx_r12.vhComponent.copyValue(form_r9.bill_code); });
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngModelChange", function ControlMoneyComponent_ng_container_73_tr_1_Template_label_ngModelChange_14_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r14); const form_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().$implicit; return (form_r9["verify_status_payment"] = $event); })("ngModelChange", function ControlMoneyComponent_ng_container_73_tr_1_Template_label_ngModelChange_14_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵrestoreView"](_r14); const form_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"]().$implicit; const ctx_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵnextContext"](); const _r5 = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵreference"](75); return ctx_r17.updateRefund(form_r9, _r5); });
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementEnd"]();
} if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](form_r9["complete_date"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" ", form_r9["bill_code"], " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate1"](" ", form_r9["status"], " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵadvance"](3);
...
function ControlMoneyComponent_ng_container_73_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtemplate"](1, ControlMoneyComponent_ng_container_73_tr_1_Template, 15, 9, "tr", 33);
...
class ControlMoneyComponent {
    constructor(vhQuerySales, vhAlgorithm, vhComponent, router, languageService, nzModalService, cdRef, vhQuery, vhAuth, modal, datePipe) {
        ...
        this.tooltipTitle = 'Vui lòng di chuyển sheet "GD Bán Hàng" lên đầu trước khi nhập tệp';
        this.infoShop = {};
    ...
    search(value) {
        if (!this.listData.length && value.length) {
            ...
            this.vhComponent.showLoading('').then(() => {
                Promise.all([this.vhQuerySales.getSalesOrderTiki_fromViethas([value], this.infoShop._id),
            ...
            this.vhAlgorithm.importXLSX(events.target.files[0]).then((data) => {
                if (data.length > 2000) { // nếu hơn 200 thì báo
                    ...
                    if (data.length) {
                        ...
                        if (!data[0]['Đơn hàng/ Order code'] || !data[0]['Giá bán/ Selling price']) {
                            ...
                            this.vhComponent.showLoading("").then(() => {
                                data.forEach((item, index) => {
                                    ...
                                    datas.push({
                                        amount: item['Doanh thu/ Revenue amount'] ? item['Doanh thu/ Revenue amount'].toString() : 0,
                                        bill_code: item['Đơn hàng/ Order code'], date: item['Ngày đặt/ Order created date'],
                                        status: item['Trạng thái đơn hàng/ Order status'],
                                        complete_date: item['Ngày hoàn thành/ Completed date']
                                    });
                                    if (index == data.length - 1) { // push tới dòng cuối thì xử lý lấy dữ liệu từ database
                                        ...
                                        // 
                                        this.vhQuerySales.getSalesOrderTiki_fromViethas(this.getOrderId(datas), this.infoShop._id)
                                            .then((array) => {
                                            // 
                                            this.vhComponent.hideLoading(0);
    ...
    getOrderIdUpdate(arr) {
        var newArr = [];
        newArr = arr.filter(i => !i.verify_status_payment).map(item => { return item.bill_code; }).filter((ele) => {
            return newArr.includes(ele) ? '' : newArr.push(ele);
        });
        return newArr;
    }
    getOrderId(arr) {
        var newArr = [];
        newArr = arr.map(item => { return item.bill_code; }).filter((ele) => {
            return newArr.includes(ele) ? '' : newArr.push(ele);
        });
        return newArr;
    }
    ...
    updateRefund(bill, updateForControl) {
        if (bill['verify_status_payment']) { // nếu update từ false trang true
            ...
            this.modal.confirm({
                ...
                nzOnOk: () => {
                    return new Promise((resolve, reject) => {
                        this.vhQuerySales.updateSalesOrderTiki_byFile([bill.bill_code], { verify_status_payment: false, id_employee_control_cashflow: this.vhAuth.getUser()._id }, this.infoShop.access_token, this.infoShop._id).then((bool) => {
                            // 
                            if (bool[0]) {
                                resolve(true);
                            }
...
/***/ 96919:
/*!*************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiki/control/control-exel/control-money/control-money.module.ts ***!
  \*************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _control_money_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./control-money.component */ 29719);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_tiki_control_control-exel_control-money_control-money_module_ts.js.map