"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_tiki_e-invoice-sales365_e-invoice-sales365_module_ts"],{

/***/ 1522:
/*!*****************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiki/e-invoice-sales365/e-invoice-sales365.component.ts ***!
  \*****************************************************************************************************/
...
function EInvoiceSales365Component_div_32_tr_43_Template(rf, ctx) {
  if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵlistener"]("click", function EInvoiceSales365Component_div_32_tr_43_Template_td_click_8_listener($event) {
      ...
      $event.stopPropagation();
      return ctx_r34.copyBillCode(invoice_r12.bill_code);
    });
...
class EInvoiceSales365Component {
  constructor(router, lang, vhComponent, vhAlgorithm, cdRef, modal, vhAuth, datePipe, vhQuerySales, vhQuery, vhEinvoice, billService, printService) {
    this.router = router;
    this.lang = lang;
  ...
  */
  ...
  ngAfterViewChecked() {
    if (document.querySelector("#control-export-goods") && document.querySelector(".ant-table-thead") && document.querySelector(".control-export-goods-header")) {
      this.heightScroll = document.querySelector("#control-export-goods").clientHeight - document.querySelector(".ant-table-thead").clientHeight - document.querySelector(".control-export-goods-header").clientHeight + "px";
    }
  ...
  gotoDetail(bill) {// this.router.navigate(['/sales/dashboard/manage/ecommerce/shopee/control/export-goods/detail'], { state: { bill: bill, dataRestore: { salesOrder: this.salesOrder, searchValue: this.searchValue, id_shop_selected: this.infoShop._id, listProduct: this.dataRestore.listProduct, date: this.date, salesSubOrder: this.salesSubOrder } } })
  }
  /**
   * Check tất cả
   * @param value
      ...
      for (let i = 0; i < bills.length; i += batchSize) {
        ...
        try {
          ...
          if (currentBatchIndex == totalBatches) {
            ...
            _this.salesOrder = _this.salesOrder.filter(data => data.cqt_status != 3);
          }
        } catch (error) {
  ...
  sendCQT(invoice) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (this.currentBranch.einvoices.length && this.currentBranch.einvoices.length == 1) {
        ...
        this.billService.changeBill_byLocal_toInvoice_byMinvoice(invoice._id, this.currentBranch.einvoices[0].invoiceSeries[0], 'TIKI', this.infoShop).then(rsp => {
          if (rsp.vcode == 0) {
  ...
  sendCQTManual(invoice) {
    ...
    if (currentBranch.einvoices.length && currentBranch.einvoices.length == 1) {
      ...
      if (currentBranch.einvoices[0].invoice_provider == 'M-invoice') {
        ...
        this.billService.changeBill_byLocal_toInvoice_byMinvoice(invoice._id, currentBranch.einvoices[0].invoiceSeries[0], 'TIKI', this.infoShop).then(rsp => {
          if (rsp.vcode == 0) {
...
/***/ 34472:
/*!**************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiki/e-invoice-sales365/e-invoice-sales365.module.ts ***!
  \**************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var src_app_sales_components_search_search_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/sales/components/search/search.module */ 43818);
/* harmony import */ var _e_invoice_sales365_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./e-invoice-sales365.component */ 1522);
...
const routes = [
    {
        path: "",
        component: _e_invoice_sales365_component__WEBPACK_IMPORTED_MODULE_2__.EInvoiceSales365Component
    },
];
...
EInvoiceSales365Module.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({ imports: [[
            ...
            src_app_sales_components_search_search_module__WEBPACK_IMPORTED_MODULE_1__.SearchModule
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](EInvoiceSales365Module, { declarations: [_e_invoice_sales365_component__WEBPACK_IMPORTED_MODULE_2__.EInvoiceSales365Component], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_5__.RouterModule, src_app_ng_zorro_ant_module__WEBPACK_IMPORTED_MODULE_0__.NgZorroAntModule,
        _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__.TranslateModule,
        _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_8__.FormsModule,
        src_app_sales_components_search_search_module__WEBPACK_IMPORTED_MODULE_1__.SearchModule] }); })();
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_tiki_e-invoice-sales365_e-invoice-sales365_module_ts.js.map