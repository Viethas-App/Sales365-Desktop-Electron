"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_tiki_issue-invoice_issue-invoice_module_ts"],{

/***/ 85610:
/*!*******************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiki/issue-invoice/issue-invoice.component.ts ***!
  \*******************************************************************************************/
...
class IssueInvoiceComponent {
    ...
    gotoInvoiceIssued() {
        var _a, _b;
        const id_shop = (_b = (_a = this.vhQuerySales.getlocalShopListTiki()) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b._id;
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiki/issue-invoice/invoice-issued'], {
            state: {
                shop_info: {
                    from_type: 'tiki_invoice_issued',
                    id_shop: id_shop,
                    bill_type: [1],
                }
            }
    ...
    gotoInvoiceReturned() {
        var _a, _b;
        const id_shop = (_b = (_a = this.vhQuerySales.getlocalShopListTiki()) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b._id;
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiki/issue-invoice/invoice-returned'], {
            state: {
                shop_info: {
                    from_type: 'tiki_invoice_returned',
                    id_shop: id_shop,
                    bill_type: [3],
                }
            }
...
/***/ 44283:
/*!****************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiki/issue-invoice/issue-invoice.module.ts ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _issue_invoice_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./issue-invoice.component */ 85610);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_tiki_issue-invoice_issue-invoice_module_ts.js.map