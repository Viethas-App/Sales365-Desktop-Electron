"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_tiki_update-stock_by-product-app_by-product-app_module_ts"],{

/***/ 18211:
/*!**********************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiki/update-stock/by-product-app/by-product-app.component.ts ***!
  \**********************************************************************************************************/
...
function ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_tr_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](24, "td", 28);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](25, "div", 34);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](26, "nz-input-number", 35);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("ngModelChange", function ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_tr_1_Template_nz_input_number_ngModelChange_26_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵrestoreView"](_r25); const product_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"]().$implicit; const ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵnextContext"](3); return ctx_r23.checkStock(product_r12, $event); });
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipe"](27, "translate");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](28, ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_tr_1_button_28_Template, 3, 5, "button", 36);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
} if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"]("", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](8, 15, "ID"), ": ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](product_r12.product_id);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](2);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](18, 19, product_r12.active == 1 ? "\u0110ang b\u00E1n" : "Ng\u1EEBng b\u00E1n"));
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind2"](21, 21, product_r12.dateUpdateStock, "dd/MM/YYYY HH:mm"));
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate1"]("", product_r12.inventory.quantity_sellable, " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpropertyInterpolate"]("nzPlaceHolder", _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](27, 24, "Enter quantity"));
...
function ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtemplate"](1, ByProductAppComponent_ng_container_56_ng_container_16_ng_container_1_tr_1_Template, 29, 26, "tr", 29);
...
class ByProductAppComponent {
    ...
    ngAfterViewChecked() {
        if (document.querySelector("#by-product-app-stock") && document.querySelector(".ant-table-thead") && document.querySelector(".by-product-app-stock-header") && document.querySelector(".ant-table-pagination")) {
            this.heightScroll = document.querySelector("#by-product-app-stock").clientHeight - document.querySelector(".ant-table-thead").clientHeight
                - document.querySelector(".by-product-app-stock-header").clientHeight - document.querySelector(".ant-table-pagination").clientHeight - 60 + "px";
        }
        ...
        if (!productApp.expand && !productApp.loaded) {
            if (productApp[this.id_branch] && productApp[this.id_branch].tikis && productApp[this.id_branch].tikis.length) {
                for (let indexProd in productApp[this.id_branch].tikis) {
                    ...
                    if (prodTiki)
                        productApp[this.id_branch].tikis[indexProd] = Object.assign(Object.assign(Object.assign({}, prodTiki), productApp[this.id_branch].tikis[indexProd]), { loading: false });
                }
    ...
    */
    updateQuantity(product, productApp) {
            ...
            if (res.state == 'approved') {
                this.vhQuerySales.getProductByIdTiki(this.infoShop['access_token'], product.product_id, this.infoShop['_id']).then((producttiki) => {
                    ...
                    if (producttiki && this.checkQuantityAfterUpdate(product, producttiki)) {
                        ...
                        this.vhQuerySales.updateMergeTikiProduct(productApp['id_subproduct'] ? productApp['id_subproduct'] : productApp['_id'], product['product_id'], { dateUpdateStock: product['dateUpdateStock'] }, this.infoShop['_id']).then((bool) => {
                            product.loading = false;
                            if (bool)
...
ByProductAppComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: ByProductAppComponent, selectors: [["app-by-product-app"]], decls: 57, vars: 45, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["id", "by-product-app-stock"], ["nz-row", "", "nzGutter", "8", 1, "by-product-app-stock-header"], ["nz-col", "", "nzSpan", "4", 1, "title"], ["nz-col", "", "nzSpan", "6"], [1, "color-green"], ["nz-col", "", "nzSpan", "6", 1, "title", "center-all-content"], [3, "nzSuffix"], ["type", "text", "nz-input", "", 3, "ngModel", "placeholder", "ngModelChange"], ["suffixIconSearch", ""], ["nz-col", "", "nzSpan", "8", 1, "right-all-content"], ["nz-row", "", "nzGutter", "16", 1, "affiliate-product-body"], ["nz-col", "", "nzSpan", "24"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzPageSize", "nzPageSizeOptions", "nzScroll", "nzNoResult", "nzData"], ["list_product_show", ""], ["nzWidth", "3%"], ["nzWidth", "10%"], ["nzWidth", "25%"], ["nzWidth", "13%"], ["nzAlign", "left", "nzWidth", "12%"], ["nzAlign", "right", "nzWidth", "10%"], ["nzWidth", "12%"], [4, "ngFor", "ngForOf", "ngForTrackBy"], ["nz-icon", "", "nzType", "search"], ["class", "icon-expand", "nz-icon", "", "nzTheme", "outline", 3, "nzType", "click", 4, "ngIf"], ["onerror", "this.src='./assets/icon/management/image_default.svg'", "width", "40px", "height", "40px", 3, "ngStyle", "src"], ["nzAlign", "right"], ["nzAlign", "center"], [4, "ngIf"], ["nz-icon", "", "nzTheme", "outline", 1, "icon-expand", 3, "nzType", "click"], [4, "ngFor", "ngForOf"], [2, "padding-left", "24px"], ["class", "color-red", 4, "ngIf"], [1, "sub-prod-update"], [3, "nzPlaceHolder", "nzMax", "nzMin", "nzStep", "ngModel", "ngModelChange"], ["nz-tooltip", "", "class", "btn-update", "nz-button", "", "nzShape", "circle", 3, "nzLoading", "nzTooltipTitle", "nzTooltipColor", "click", 4, "ngIf"], [1, "color-red"], ["nz-tooltip", "", "nz-button", "", "nzShape", "circle", 1, "btn-update", 3, "nzLoading", "nzTooltipTitle", "nzTooltipColor", "click"], ["nz-icon", "", "nzType", "upload", "nzTheme", "outline"]], template: function ByProductAppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵpipeBind1"](50, 38, "Stock"));
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵadvance"](4);
...
/***/ 2394:
/*!*******************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiki/update-stock/by-product-app/by-product-app.module.ts ***!
  \*******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _by_product_app_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./by-product-app.component */ 18211);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_tiki_update-stock_by-product-app_by-product-app_module_ts.js.map