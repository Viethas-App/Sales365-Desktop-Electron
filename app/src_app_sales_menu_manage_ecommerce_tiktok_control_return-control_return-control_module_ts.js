"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_tiktok_control_return-control_return-control_module_ts"],{

/***/ 10912:
/*!********************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/control/return-control/control-diary/control-diary.component.ts ***!
  \********************************************************************************************************************/
...
class ControlDiaryComponent {
    ...
    goBack() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/control/return-control'], {
            state: {
...
/***/ 23161:
/*!**************************************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/control/return-control/return-control-content/return-control-content.component.ts ***!
  \**************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ReturnControlContentComponent {
    ...
    search(value) {
        ...
        console.log('id_shop--------', this.infoShop);
        // this.vhEcommerce.getSalesOrderTiktok_fromViethas([value], this.infoShop._id).then((array: any) => {
        //   console.log('array', array);
        // }, (error: any) => {
        //   console.log('error', error);
        // })
        this.vhEcommerce.getSalesOrderDetailTiktok(value, this.infoShop.shop_cipher, this.infoShop.app_key, this.infoShop.access_token.toString(), this.infoShop._id)
        ...
        //     Promise.all([
        //       this.vhEcommerce.getSalesOrderTiktok_fromViethas([value], this.infoShop._id),
        //       this.vhEcommerce.getSalesOrderDetailTiktok(value,this.infoShop.shop_cipher, this.infoShop.app_key, this.infoShop.access_token.toString(), this.infoShop._id)
        //     ])
        //       .then((array: any) => {
        //         this.vhComponent.hideLoading(0);
        ...
        //               ...array[1], ...array[0][0],
        //               create_at: new Date(array[1].create_time * 1000),
        //               bill_code: value,
        //               name_control_goods: array[1].verify_status_received_goods ? `${this.vhAuth.getlocalEmployee(array[1].id_verifier_received_goods).name} ${this.languageService.translate("has checked")} ${this.format_date(array[1].verify_date_received_goods)}` : null
        //             }]);
        //             if (!array[1].verify_status_received_goods) this.listOrderCode.push(value)
        //           }
        //         }
        //       }, error => {
        //         this.vhComponent.hideLoading(0);
    ...
    */
    updateRefund(bill, updateForControl) {
        if (bill['verify_status_received_goods']) { // nếu update từ false trang true
            ...
            this.modal.confirm({
                ...
                nzOnOk: () => {
                    return new Promise((resolve, reject) => {
                        this.vhEcommerce.updateSalesOrderTiktok_byFile([bill.bill_code], { verify_status_received_goods: false, id_employee_received_goods: this.vhAuth.getUser()._id }, this.infoShop.shop_cipher, this.infoShop.app_key, this.infoShop.access_token, this.infoShop._id).then((bool) => {
                            // 
                            if (bool[0]) {
     ...
     */
    getKeyUp(_event) {
        if (this.router.url === "/sales/dashboard/manage/ecommerce/tiktok/control/return-control/return-control-content") {
            ...
            nzOnOk: () => {
                this.vhComponent.showLoading('').then(() => {
                    ...
                    if (this.listOrderCode.length)
                        ...
                        }, this.infoShop.shop_cipher, this.infoShop.app_key, shop.access_token, shop._id)
                            .then((res) => {
                            // 
...
/***/ 81231:
/*!*******************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/control/return-control/return-control.component.ts ***!
  \*******************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ReturnControlComponent {
    ...
    gotoMoneyControl() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/control/return-control/return-control-content'], { state: { dataRestore: this.dataRestore } });
    }
    gotoDiary() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/control/return-control/diary-control'], { state: { dataRestore: this.dataRestore } });
    }
}
...
/***/ 9795:
/*!****************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/control/return-control/return-control.module.ts ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _return_control_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./return-control.component */ 81231);
/* harmony import */ var _control_diary_control_diary_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./control-diary/control-diary.component */ 10912);
/* harmony import */ var _return_control_content_return_control_content_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./return-control-content/return-control-content.component */ 23161);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_tiktok_control_return-control_return-control_module_ts.js.map