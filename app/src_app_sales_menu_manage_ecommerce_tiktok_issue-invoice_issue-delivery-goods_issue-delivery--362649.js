"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_tiktok_issue-invoice_issue-delivery-goods_issue-delivery--362649"],{

/***/ 5291:
/*!************************************************************************************!*\
  !*** ./src/app/sales/components/bill-type/bill-type-1/tiktok/add/add.component.ts ***!
  \************************************************************************************/
...
class AddComponent {
  constructor(router, vhComponent, languageService, vhQuerySales, vhAlgorithm, vhAuth, fncService, nzModalService, cdf, vhEcommerce) {
    ...
    this.billTiktok = this.router.getCurrentNavigation().extras.state.billTiktok;
    this.employee = {};
    this.customer = {};
    this.pickerTime = new Date();
    this.checkPrinter = false;
    this.validProdDetail = true; //nếu biến này = false tức có sp Tiktok chưa được liên kết với app
  ...
  /**Khởi tạo hóa đơn và merge sp của Tiktok vào billDetail */
  ...
  initBill() {
    ...
    this.invoice.id_customer = this.vhEcommerce.getlocalShopListTiktok().find(item => item._id == this.dataRestore.id_shop_selected).data.id_customer;
    this.customer = this.vhQuerySales.getlocalCustomer(this.invoice.id_customer);
    this.invoice.discount = Number(this.billTiktok.payment.platform_discount) + Number(this.billTiktok.payment.seller_discount);
    this.invoice.fee = Number(this.billTiktok.payment.shipping_fee);
    this.invoice.tax = Number(this.billTiktok.payment.tax);
    this.addInvoiceDetail(this.billTiktok.line_items);
    this.setSubTotal();
    this.invoice.order_number_ecommerce = this.billTiktok['id'].toString();
    this.invoice.id_shop = this.dataRestore['id_shop_selected'];
    this.invoice.note = `${this.languageService.translate("Order number")} Tiktok ${this.billTiktok.id}`;
    ...
    this.invoice.cqt_status = this.billTiktok.cqt_status ? this.billTiktok.cqt_status : 1;
            ...
            this.createOrUpdate(1).then(bill => {
              ...
              let update = /*#__PURE__*/function () {
                var _ref = (0,C_GitHub_Sales365_Desktop_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)(function* () {
                  return yield _this.vhEcommerce.updateSalesOrderTiktok(_this.dataRestore['id_shop_selected'], _this.billTiktok['id'].toString(), {
  ...
  */
  ...
  addInvoiceDetail(line_items) {
    let products = this.vhQuerySales.getlocalDetailProducts(35).filter(e => !e.delete_hidden).filter(item => item[this.id_branch] && item[this.id_branch].tiktoks && item[this.id_branch].tiktoks.length >= 0);

    for (let item of line_items) {
      let findSuccess = false;

      for (let productOfBranch of products) {
        let findProduct = productOfBranch[this.id_branch].tiktoks.find(data => data.id == item.id_product);
        ...
        if (findProduct) {
          if (findProduct.skus && findProduct.skus.length) {
            ...
            if (indexSku >= 0) {
              this.addInvoiceDetailTiktok(Number(item.sale_price), Number(item.original_price), productOfBranch, true);
              findSuccess = true;
              break;
            }
          } else {
      ...
      if (!findSuccess) {
        this.addInvoiceDetailTiktok(Number(item.sale_price), Number(item.original_price), {
   ...
   * @param product
   * @param exist
   * @example addInvoiceDetailTiktok(price_on_Tiktok, product, false)
   */


  addInvoiceDetailTiktok(price, price_origin, product, exist) {
    if (exist) {
      const productToAdd = {
        name: product.name,
...
AddComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵdefineComponent"]({
  type: AddComponent,
  selectors: [["bill-type1-tiktok-add"]],
  decls: 110,
  vars: 81,
  ...
  template: function AddComponent_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵadvance"](2);
      _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵpropertyInterpolate1"]("href", "https://seller-vn.tiktok.com/order/detail?order_no=", ctx.billTiktok.id, "&shop_region=VN", _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵsanitizeUrl"]);
      _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵadvance"](1);
      _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵtextInterpolate"](ctx.billTiktok.id);
      _angular_core__WEBPACK_IMPORTED_MODULE_13__["ɵɵadvance"](5);
...
/***/ 92871:
/*!*******************************************************************************************!*\
  !*** ./src/app/sales/components/bill-type/bill-type-1/tiktok/bill-type1-tiktok.module.ts ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "BillType1TiktokModule": () => (/* binding */ BillType1TiktokModule)
/* harmony export */ });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @angular/common */ 54364);
/* harmony import */ var _add_add_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./add/add.component */ 5291);
/* harmony import */ var _edit_edit_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./edit/edit.component */ 79040);
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail/detail.component */ 3333);
...
class BillType1TiktokModule {
}
BillType1TiktokModule.ɵfac = function BillType1TiktokModule_Factory(t) { return new (t || BillType1TiktokModule)(); };
BillType1TiktokModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineNgModule"]({ type: BillType1TiktokModule });
BillType1TiktokModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineInjector"]({ imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵsetNgModuleScope"](BillType1TiktokModule, { declarations: [_add_add_component__WEBPACK_IMPORTED_MODULE_0__.AddComponent,
...
/***/ 3333:
/*!******************************************************************************************!*\
  !*** ./src/app/sales/components/bill-type/bill-type-1/tiktok/detail/detail.component.ts ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class DetailComponent {
    ...
    */
    ...
    /**
     * trở về trang phát hành hóa đơn Tiktok
     * @example this.goBack()
     */
    goBack() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods'], { state: { dataRestore: this.dataRestore } });
    }
    ngAfterViewChecked() {
    ...
    /**
     * router trang cập nhật phát hành hóa đơn Tiktok
     * @example this.goToCart()
     */
    goToCart() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/edit'], { state: { dataRestore: this.dataRestore, invoiceDetail: this.invoice_detail, invoice: this.invoice, billTiktok: this.billTiktok } });
    }
}
...
/***/ 79040:
/*!**************************************************************************************!*\
  !*** ./src/app/sales/components/bill-type/bill-type-1/tiktok/edit/edit.component.ts ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class EditComponent {
    ...
    goBack() {
        this.vhComponent.alertConfirm(`${this.languageService.translate("Confirm")}`, "", `${this.languageService.translate("Are you sure to cancel the sales order")}?`, "OK", this.languageService.translate('Cancel'))
            .then(() => { this.isExit = true; this.router.navigate(["/sales/dashboard/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods"], { state: { dataRestore: this.dataRestore } }); }, () => { });
    }
    // -------set employee-------
    closeAndReceiveEmployee(event) {
        if (event) {
    ...
    */
     ...
     */
    addInvoiceDetail(billTiktok) {
        let order_items = billTiktok.order_items.filter(e => !e.reason);
        let freeShipMax = 0;
        let paymet_fee = 0;
        let products = this.vhQuerySales.getlocalDetailProducts(35).filter(e => !e.delete_hidden).filter(item => item[this.id_branch] && item[this.id_branch].Tiktoks && item[this.id_branch].Tiktoks.length >= 0);
        for (let order_item of order_items) {
            ...
            for (let productApp of products) {
                for (let productTiktok of productApp[this.id_branch].Tiktoks) {
                    let findProd = productTiktok.skus.find(sku => sku.SkuId == order_item.sku_id);
                    if (findProd) {
                        findSuccess = true;
                        this.addInvoiceDetailTiktok(order_item.item_price, productApp, true);
                        break;
                    }
                }
                if (findSuccess)
            ...
            if (!findSuccess) {
                this.addInvoiceDetailTiktok(order_item.item_price, { name: order_item.name }, false);
                this.validProdDetail = false;
            }
        }
        let fee = parseFloat(freeShipMax.toFixed(2));
        this.invoice.discount = ((fee > 16500 ? 16500 : fee) + parseFloat(paymet_fee.toFixed(2)) + billTiktok.shipping_fee_discount_seller);
    }
    addInvoiceDetailTiktok(price, product, exist) {
...
EditComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineComponent"]({ type: EditComponent, selectors: [["bill-type1-tiktok-edit"]], decls: 110, vars: 81, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], [1, "sales", "hide-best-selling"], [1, "sales-cart"], ["nz-row", "", 1, "sales-cart-header", 3, "nzGutter"], ["nz-col", "", "nzSpan", "12", 1, "title"], ["target", "_blank", 3, "href"], ["nz-col", "", "nzSpan", "12", 1, "right-all-content"], ["nz-button", "", "nzType", "default", 1, "btn-data", "nz-hover-border", 2, "width", "97%", 3, "click"], ["nz-icon", "", "nzType", "search", "nzTheme", "outline"], [1, "hideScrollbar", "sales-cart-invoiceDetail"], ["class", "invoiceDetail-item", 4, "ngFor", "ngForOf"], [1, "sales-bills"], ["nz-row", "", 1, "sales-bills-staff", "hideScrollbar"], ["nz-col", "", "nzSpan", "24"], [1, "sales-bills-staff-name"], [3, "id_employee", "closeAndReceiveEmployee"], ["nz-col", "", "nzSpan", "24", 1, "sales-bills-staff-time"], ["nzBorderless", "", "nzShowTime", "", "nzFormat", "dd/MM/yyyy HH:mm:ss", 2, "text-align-last", "right", 3, "ngModel", "ngModelChange"], [1, "sales-bills-customer", "hideScrollbar"], ["nz-col", "", "nzSpan", "24", "nz-row", "", 1, "sales-bills-customer-info"], [2, "width", "100%", "margin-bottom", "12px"], [1, "sales-bills-customer-info-name"], [1, "sales-bills-customer-info-phone"], ["nz-col", "", "nzSpan", "24", "nz-row", "", 1, "sales-bills-customer-info", 2, "margin-top", "12px"], [2, "width", "100%", "margin-bottom", "12px", "color", "var(--ion-color-vh-green)", "cursor", "pointer", 3, "click"], ["nz-row", "", 1, "sales-bills-content", "hideScrollbar"], ["nz-col", "", "nzSpan", "24", 1, "sales-bills-content-discount"], ["nzTooltipPlacement", "top", "nz-tooltip", "", "nz-icon", "", "nzType", "exclamation-circle", "nzTheme", "outline", 2, "font-size", "0.9rem", "color", "var(--ion-color-vh-red)", ";margin-left", "4px", 3, "nzTooltipTitle"], ["type", "text", "maxlength", "15", "id", "discount-price", "nz-input", "", 1, "nz-no-border", "discount-price", 3, "value", "blur"], ["nz-col", "", "nzSpan", "24", 1, "sales-bills-content-fee"], ["type", "text", "maxlength", "15", "id", "invoice-fee", "nz-input", "", 1, "nz-no-border", "invoice-fee", 3, "value", "blur"], ["nz-col", "", "nzSpan", "24", 1, "sales-bills-content-total"], ["nz-col", "", "nzSpan", "24", 1, "sales-bills-content-pay"], ["nz-col", "", "nzSpan", "24", 1, "sales-bills-content-rest"], ["nz-col", "", "nzSpan", "24", 1, "sales-bills-content-note"], ["nz-input", "", 1, "nz-hover-border", 3, "ngModel", "placeholder", "nzAutosize", "ngModelChange"], ["nz-row", "", 1, "sales-bills-button"], ["nz-button", "", 1, "order-and-print", 3, "disabled", "click"], ["nz-button", "", 1, "order", 3, "disabled", "click"], [3, "searchProductList", "default_price_type", "closeSearchProductList", 4, "ngIf"], [3, "nzFooter", "nzVisible", "nzTitle", "nzVisibleChange", "nzOnCancel", "nzOnOk", 4, "ngIf"], [3, "nzFooter", "nzVisible", "nzTitle", "nzVisibleChange", "nzOnCancel", "nzOnOk"], [4, "nzModalContent"], ["modalFooterEditUnitPrice2", ""], ["nzWidth", "70vw", 3, "nzFooter", "nzVisible", "nzTitle", "nzVisibleChange", "nzOnCancel", "nzOnOk", 4, "ngIf"], [3, "isOpenModal", "invoice", "onClose", "onOk"], [1, "invoiceDetail-item"], ["nz-row", ""], ["nz-col", "", "nzSpan", "1", 3, "click"], ["nz-icon", "", "nzType", "close", "nzTheme", "outline", 2, "cursor", "pointer", "color", "var(--ion-color-vh-red)"], ["nz-col", "", "nzSpan", "8"], [1, "invoiceDetail-item-name"], ["class", "invoiceDetail-item-name-linked", 4, "ngIf"], [4, "ngIf"], ["style", "font-size: 0.75rem; color: var(--ion-color-vh-black); font-weight: normal;", 4, "ngFor", "ngForOf"], ["nz-col", "", "nzSpan", "5", 2, "text-align", "right"], [3, "ngModel", "nzMin", "ngModelChange"], ["nz-col", "", "nzSpan", "5", 1, "invoiceDetail-item-price", "text-end"], [1, "max-width-two-line", 2, "border-bottom", "1px var(--ion-color-vh-gray) solid", "margin-left", "16px"], [2, "margin-left", "5px", "font-size", "0.8rem"], [1, "max-width-two-line"], [1, "invoiceDetail-item-name-linked"], ["style", "color:var(--ion-color-vh-green);cursor: pointer;", 3, "click", 4, "ngIf"], [2, "color", "var(--ion-color-vh-green)", "cursor", "pointer", 3, "click"], [2, "font-size", "0.75rem", "color", "var(--ion-color-vh-black)", "font-weight", "normal"], [1, "invoiceDetail-item-name-notlinked"], [3, "searchProductList", "default_price_type", "closeSearchProductList"], ["modalFooterEditUnitPrice", ""], ["nz-col", "", "nzSpan", "8", 1, "center-col"], ["nz-col", "", "nzSpan", "16"], ["type", "text", "maxlength", "15", "nz-input", "", 1, "unit_price", 3, "value", "placeholder"], ["nz-button", "", "nzType", "default", 1, "nz-hover-border", 2, "background-color", "var(--ion-color-vh-white)", "color", "var(--ion-color-vh-black)", 3, "click"], ["nz-button", "", 1, "nz-hover-border-green", 2, "background-color", "var(--ion-color-vh-green)", "color", "var(--ion-color-vh-white)", 3, "click"], [3, "nzSuffix"], ["type", "text", "nz-input", "", 3, "placeholder", "keyup"], ["searchValue", ""], ["suffixIconSearch", ""], [2, "width", "100%", 3, "ngModel", "ngModelChange"], ["nz-row", "", 4, "ngFor", "ngForOf"], ["style", "text-align: center;", 4, "ngIf"], ["nz-icon", "", "nzType", "search"], ["nz-radio", "", 1, "radio-purchase", 2, "width", "100%", 3, "nzValue"], [2, "text-align", "center"], ["nz-button", "", 1, "nz-hover-border-green", 2, "background-color", "var(--ion-color-vh-green)", "color", "var(--ion-color-vh-white)", 3, "disabled", "click"], ["nzWidth", "70vw", 3, "nzFooter", "nzVisible", "nzTitle", "nzVisibleChange", "nzOnCancel", "nzOnOk"], ["modalFooterEditUnitPrice3", ""], [3, "nzData", "nzShowPagination", "nzScroll"], ["basicTable", ""], [4, "ngFor", "ngForOf"], ["nzShowSearch", "", 3, "nzPlaceHolder", "ngModel", "ngModelChange"], [3, "nzLabel", "nzValue", 4, "ngFor", "ngForOf"], [3, "nzLabel", "nzValue"]], template: function EditComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵpropertyInterpolate1"]("href", "https://seller-vn.tiktok.com/order/detail?order_no=", ctx.billTiktok.id, "&shop_region=VN", _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵsanitizeUrl"]);
        _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtextInterpolate"](ctx.billTiktok.id);
        _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵadvance"](5);
...
/***/ 76210:
/*!************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/add/add.component.ts ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _components_bill_type_bill_type_1_tiktok_add_add_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../../../components/bill-type/bill-type-1/tiktok/add/add.component */ 5291);
...
AddComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: AddComponent, selectors: [["app-add"]], decls: 1, vars: 0, template: function AddComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "bill-type1-tiktok-add");
    } }, directives: [_components_bill_type_bill_type_1_tiktok_add_add_component__WEBPACK_IMPORTED_MODULE_0__.AddComponent], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhZGQuY29tcG9uZW50LnNjc3MifQ== */"] });
...
/***/ 45418:
/*!************************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/detailTiktok/detail.component.ts ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DetailComponentTiktok": () => (/* binding */ DetailComponentTiktok)
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 2316);
...
function DetailComponentTiktok_nz_layout_4_div_37_Template(rf, ctx) { if (rf & 1) {
...
function DetailComponentTiktok_nz_layout_4_div_38_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](1, "div", 10);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipe"](3, "translate");
...
function DetailComponentTiktok_nz_layout_4_nz_table_78_tr_33_Template(rf, ctx) { if (rf & 1) {
...
function DetailComponentTiktok_nz_layout_4_nz_table_78_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](33, DetailComponentTiktok_nz_layout_4_nz_table_78_tr_33_Template, 30, 16, "tr", 31);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
} if (rf & 2) {
    const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](1);
    const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("nzScroll", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpureFunction1"](26, _c0, ctx_r3.heightScroll))("nzData", ctx_r3.bill.order_details)("nzPageSize", 20)("nzPageSizeOptions", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpureFunction0"](28, _c1));
...
function DetailComponentTiktok_nz_layout_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DetailComponentTiktok_nz_layout_4_Template_span_click_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r11); const ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r10.vhComponent.copyValue(ctx_r10.bill.id); });
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](7);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](37, DetailComponentTiktok_nz_layout_4_div_37_Template, 9, 6, "div", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](38, DetailComponentTiktok_nz_layout_4_div_38_Template, 7, 4, "div", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](78, DetailComponentTiktok_nz_layout_4_nz_table_78_Template, 34, 29, "nz-table", 19);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx_r0.bill.order_details.length > 0);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](6);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" -", ctx_r0.vhAlgorithm.vhcurrencyunit(ctx_r0.bill.payment.shipping_fee_platform_discount * 1 + ctx_r0.bill.payment.shipping_fee_cofunded_discount * 1), " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](3);
...
class DetailComponentTiktok {
    ...
    ngOnInit() {
        ...
        this.bill['order_details'].forEach(item => {
...
DetailComponentTiktok.ɵfac = function DetailComponentTiktok_Factory(t) { return new (t || DetailComponentTiktok)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__.Router), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ionic_vhframeworks__WEBPACK_IMPORTED_MODULE_3__.VhEcommerce), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__.ChangeDetectorRef), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](ionic_vhframeworks__WEBPACK_IMPORTED_MODULE_3__.VhAlgorithm), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](src_app_sales_components_vh_component_vh_component__WEBPACK_IMPORTED_MODULE_0__.VhComponent)); };
DetailComponentTiktok.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: DetailComponentTiktok, selectors: [["app-detail"]], decls: 5, vars: 4, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["id", "order-status-sendo", 4, "ngIf"], ["id", "order-status-sendo"], ["nz-row", "", 1, "order-status-sendo-header"], ["nz-col", "", "nzSpan", "16", 1, "title"], [2, "color", "#ee2624", 3, "click"], ["nz-icon", "", "nzType", "copy", "nzTheme", "outline"], ["nz-col", "", "nzSpan", "8", 1, "right-all-content"], ["nz-row", "", "id", "bill-info"], ["nz-col", "", "nzSpan", "8"], ["nz-row", ""], ["nz-col", "", "nzSpan", "16"], ["nz-row", "", 4, "ngIf"], ["nz-col", "", "nzSpan", "24", 1, "title"], ["nz-row", "", "id", "buyer-info"], ["nz-row", "", 2, "margin-bottom", "8px"], ["nz-col", "", "nzSpan", "2"], ["nz-col", "", "nzSpan", "22"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzScroll", "nzData", "nzPageSize", "nzPageSizeOptions", 4, "ngIf"], ["nz-row", "", "id", "payment-info", 2, "display", "flex", "justify-content", "space-between"], ["nz-col", "", "nzSpan", "10"], ["nz-col", "", "nzSpan", "12"], ["nz-col", "", "nzSpan", "12", 1, "text-end"], ["nz-col", "", "nzSpan", "12", 1, "text-end", "title"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzScroll", "nzData", "nzPageSize", "nzPageSizeOptions"], ["salesOrder_show", ""], ["nzLeft", "", "nzWidth", "12%"], ["nzLeft", "", "nzWidth", "34%"], ["nzWidth", "8%"], ["nzWidth", "13%"], [4, "ngFor", "ngForOf"], ["alt", "", 3, "src"], [3, "click"], ["nz-icon", "", "nzType", "copy", "nzTheme", "outline", 3, "click"], ["nzRight", "", "nzWidth", "13%"]], template: function DetailComponentTiktok_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function DetailComponentTiktok_Template_div_click_0_listener() { return ctx.goBack(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](1, "i", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](2);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipe"](3, "translate");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](4, DetailComponentTiktok_nz_layout_4_Template, 135, 78, "nz-layout", 2);
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
...
/***/ 70957:
/*!******************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/detail/detail.component.ts ***!
  \******************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 2316);
/* harmony import */ var _components_bill_type_bill_type_1_tiktok_detail_detail_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../../../components/bill-type/bill-type-1/tiktok/detail/detail.component */ 3333);
...
/***/ 20120:
/*!**************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/edit/edit.component.ts ***!
  \**************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 2316);
/* harmony import */ var _components_bill_type_bill_type_1_tiktok_edit_edit_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../../../components/bill-type/bill-type-1/tiktok/edit/edit.component */ 79040);
...
EditComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: EditComponent, selectors: [["app-edit"]], decls: 1, vars: 0, template: function EditComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "bill-type1-tiktok-edit");
    } }, directives: [_components_bill_type_bill_type_1_tiktok_edit_edit_component__WEBPACK_IMPORTED_MODULE_0__.EditComponent], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJlZGl0LmNvbXBvbmVudC5zY3NzIn0= */"] });
...
/***/ 29140:
/*!*************************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/issue-delivery-goods.component.ts ***!
  \*************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_10_i_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "i", 49);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_10_i_2_Template_i_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r22); const item_r18 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"]().$implicit; const ctx_r20 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](4); $event.stopPropagation(); return ctx_r20.openModelSelectProductsTiktok(item_r18); });
...
function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_10_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](2, IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_10_i_2_Template, 1, 0, "i", 48);
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵstyleProp"]("color", ctx_r14.isLinkedToProduct(item_r18) ? "" : "var(--ion-color-vh-red)");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate2"](" ", ctx_r14.isLinkedToProduct(item_r18) ? ctx_r14.findProductLinked(item_r18).name : item_r18.product_name + " - " + item_r18.sku_name, " (SL :", item_r18.quantity, ") ");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngIf", !ctx_r14.isLinkedToProduct(item_r18));
} }
function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_19_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_19_Template_span_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r25); const bill_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"]().$implicit; const ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](3); $event.stopPropagation(); return ctx_r23.gotoCreateBill(bill_r12); });
...
function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_20_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_20_Template_span_click_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r28); const bill_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"]().$implicit; const ctx_r26 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](3); $event.stopPropagation(); return ctx_r26.gotoDetail(bill_r12); });
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](1, "b");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipe"](3, "translate");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
...
function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_label_22_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("ngModelChange", function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_label_22_Template_label_ngModelChange_0_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r31); const bill_r12 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"]().$implicit; const ctx_r29 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](3); return ctx_r29.checkBillToCreateInvoice($event, bill_r12); });
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
} if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngModel", ctx_r17.selectedBills[bill_r12.id]);
} }
function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_Template_tr_click_0_listener() { const restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r34); const bill_r12 = restoredCtx.$implicit; const ctx_r33 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](3); return ctx_r33.gotoDetailTiktok(bill_r12); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](8, "i", 40);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("click", function IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_Template_i_click_8_listener($event) { const restoredCtx = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r34); const bill_r12 = restoredCtx.$implicit; const ctx_r35 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](3); $event.stopPropagation(); return ctx_r35.vhComponent.copyValue(bill_r12.id); });
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](9, "td");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](10, IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_10_Template, 4, 5, "span", 41);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](15, "td", 42);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](16, "b");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtext"](17);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](18, "td", 43);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](19, IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_19_Template, 4, 3, "span", 44);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](20, IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_span_20_Template, 4, 3, "span", 45);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](21, "td", 43);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](22, IssueDeliveryGoodsComponent_div_32_nz_table_2_tr_39_label_22_Template, 1, 1, "label", 46);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
} if (rf & 2) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate1"](" ", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind2"](5, 9, bill_r12.create_at, "dd/MM/yyyy HH:mm"), "");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate1"](" ", bill_r12.id, " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("ngForOf", bill_r12.order_details);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](14, 12, bill_r12.status));
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate"](ctx_r11.vhAlgorithm.vhcurrencyunit(bill_r12.payment.total_amount));
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](2);
...
function IssueDeliveryGoodsComponent_div_32_nz_table_2_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](23, 23, "Status on Tiktok"));
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵadvance"](4);
...
function IssueDeliveryGoodsComponent_ng_template_33_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵtemplate"](0, IssueDeliveryGoodsComponent_ng_template_33_div_0_Template, 4, 3, "div", 53);
} if (rf & 2) {
...
function IssueDeliveryGoodsComponent_ng_template_37_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](5, "nz-date-picker", 59);
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("ngModelChange", function IssueDeliveryGoodsComponent_ng_template_37_Template_nz_date_picker_ngModelChange_5_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r42); const ctx_r41 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"](); return ctx_r41.bill_selected.date_control = $event; });
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementEnd"]();
} if (rf & 2) {
...
class IssueDeliveryGoodsComponent {
    ...
    */
    ...
    goBack() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/issue-invoice'], {
            state: { dataRestore: this.dataRestore }
        });
    }
    changeTime(event) {
    ...
    showReport() {
        ...
        this.salesOrder = [];
        this.vhComponent.showLoading("", "transparent-loading").then(() => {
            this.vhEcommerce.getSalesOrderListTiktok(new Date(this.datePipe.transform(new Date(this.date[0].setHours(0, 0, 0)), "yyyy-MM-dd HH:mm:ss").toString()), new Date(this.datePipe.transform(new Date(this.date[1].setHours(23, 59, 59)), "yyyy-MM-dd HH:mm:ss").toString()), this.infoShop.shop_cipher, this.infoShop.app_key, this.infoShop.access_token.toString(), this.infoShop._id.toString())
                .then((result) => {
                this.vhComponent.hideLoading(0);
                result.forEach(item => {
                    if (item.verify_status_delivered_goods)
                        this.salesOrder.push(Object.assign(Object.assign({}, item), { create_at: new Date(item.create_time * 1000) }));
                });
                this.salesOrder = this.processOrders(this.salesOrder);
                this.salesSubOrder = [...this.salesOrder];
            })
    ...
    processOrders(orders) {
        ...
        return orders.map(order => {
            ...
            order.line_items.forEach(item => {
                ...
                if (!lineItemMap[key]) {
                    lineItemMap[key] = Object.assign(Object.assign({}, item), { quantity: 1, total_price: item.price });
                }
                else {
            ...
            return Object.assign(Object.assign({}, order), { order_details: Object.values(lineItemMap) });
        });
    }
    changeShop(event) { }
    ngAfterViewChecked() {
        if (document.querySelector("#tiktok-issue-invoice") && document.querySelector(".ant-table-thead") && document.querySelector(".tiktok-issue-invoice-header") && document.querySelector(".ant-table-pagination")) {
            this.heightScroll = document.querySelector("#tiktok-issue-invoice").clientHeight - document.querySelector(".ant-table-thead").clientHeight
                - document.querySelector(".tiktok-issue-invoice-header").clientHeight - 90 + "px";
        }
        this.cdRef.detectChanges();
    }
    gotoCreateBill(bill) {
        ...
        if (customer) {
            this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/add'], {
                state: { dataRestore: Object.assign(Object.assign({}, this.dataRestore), { searchValue: this.searchValue, id_shop_selected: this.infoShop._id, date: this.date, salesOrder: this.salesOrder }), billTiktok: bill }
            });
        }
        else
    ...
    gotoDetail(bill) {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/detail'], {
            state: { dataRestore: Object.assign(Object.assign({}, this.dataRestore), { searchValue: this.searchValue, id_shop_selected: this.infoShop._id, date: this.date, salesOrder: this.salesOrder }), id: bill.id_bill_delivered_goods, billTiktok: bill }
        });
    }
    gotoDetailTiktok(bill) {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/detail-tiktok'], {
            state: {
                bill: bill,
                dataRestore: {
    ...
    getGroupedItemsCached(line_items) {
        const key = JSON.stringify(line_items);
        if (!this.groupedItemsMap.has(key)) {
            const listProduct = this.vhEcommerce.getlocalProductListTiktok(this.infoShop['_id']).filter(item => item.status == 'ACTIVATE');
            const grouped = new Map();
            for (const item of line_items) {
                const currentProductTiktok = listProduct.find(product => { var _a; return (_a = product.skus) === null || _a === void 0 ? void 0 : _a.some(sku => sku.id === item.sku_id); });
                item.id_product = currentProductTiktok === null || currentProductTiktok === void 0 ? void 0 : currentProductTiktok.id;
                if (grouped.has(item.sku_id)) {
                    grouped.get(item.sku_id).quantity += 1;
                }
                else {
                    grouped.set(item.sku_id, {
                        id: (currentProductTiktok === null || currentProductTiktok === void 0 ? void 0 : currentProductTiktok.id) ? String(currentProductTiktok.id) : '',
    ...
    */
    ...
    toggleSelectAll(checked) {
        ...
        for (let bill of this.salesOrder) {
            ...
            if (canSelect) {
                this.selectedBills[bill.id] = checked;
                if (checked) {
    ...
    billIsLinkedToProduct(bill) {
        return bill.order_details.every(item => {
            return this.isLinkedToProduct(item);
        });
    }
    checkBillToCreateInvoice(bool, bill) {
        this.selectedBills[bill.id] = bool;
        if (bool) {
            this.listInvoiceSelected.push(bill);
        }
        else {
            this.listInvoiceSelected = this.listInvoiceSelected.filter(item => item.id != bill.id);
        }
        const allBillsCanSelect = this.salesOrder.filter(b => !b.id_bill_delivered_goods && this.billIsLinkedToProduct(b));
        this.checkAll = allBillsCanSelect.every(b => this.selectedBills[b.id]);
    }
    ...
    acceptAfiliate(product) {
        ...
        this.nzModalService.confirm({
            ...
            nzOnOk: () => {
                this.vhComponent.showLoading("", "transparent-loading").then(() => {
                    // Tìm sản phẩm tiktok
                    const currentProductTiktok = this.listProductTiktok.find(product => { var _a; return (_a = product.skus) === null || _a === void 0 ? void 0 : _a.some(sku => sku.id === this.productTiktokSelected.sku_id); });
                    console.log(this.listProductTiktok);
                    ...
                    if (indexProd >= 0) {
                        if (listProduct[indexProd].skus && item.skus && item.skus.length) {
                            for (let skus of item.skus) {
                                ...
                                if (index >= 0)
                                    listProduct[indexProd].skus.splice(index, 1);
                            }
                            if (!listProduct[indexProd].skus.length)
        ...
        this.vhComponent.alertConfirm(`${this.lang.translate("Pay")}?`, "", "", "OK", this.lang.translate("Cancel"))
            ...
            this.vhComponent.showLoading("", "transparent-loading").then(() => {
                ...
                for (let index = 0; index < this.listInvoiceSelected.length; index++) {
                    const billTiktok = this.listInvoiceSelected[index];
                    this.initBill(billTiktok);
                    const promise = this.createOrUpdate(1).then((bill) => {
                        this.salesOrder.find(item => item.id == billTiktok['id']).id_bill_delivered_goods = bill._id;
                        if (this.invoice.cqt_status !== 1) {
                            this.vhQuerySales.updateBill(bill._id, { cqt_status: this.invoice.cqt_status });
                        }
                        return this.vhEcommerce.updateSalesOrderTiktok(this.infoShop._id, billTiktok['id'].toString(), { id_bill_delivered_goods: bill._id });
                    });
    ...
    createOrUpdate(bill_type) {
        return new Promise((resolve, reject) => {
            this.vhQuerySales.createBill_Billdetail(Object.assign({}, this.invoice), this.getCreateUpdateInvoiceDetail()).then(res => {
                resolve(res);
    ...
    addInvoiceDetail(line_items) {
        ...
        for (let item of line_items) {
            ...
            if (!findSuccess) {
                this.addInvoiceDetailTiktok(Number(item.sale_price), Number(item.original_price), { name: item.product_name }, false);
            }
        }
    }
    /**
    ...
    initBill(billTiktok) {
        ...
        this.employee = this.vhAuth.getlocalEmployee(this.invoice.id_employee);
        this.invoice.id_branch = (this.vhQuerySales.getDefaultBranch()._id);
        this.invoice.id_customer = (this.vhEcommerce.getlocalShopListTiktok().find(item => item._id == this.infoShop._id).data.id_customer);
        this.customer = this.vhQuerySales.getlocalCustomer(this.invoice.id_customer);
        this.invoice.payment_type = (2); //set bill công nợ
        this.invoice.discount = Number(billTiktok.payment.platform_discount) + Number(billTiktok.payment.seller_discount);
        this.invoice.fee = Number(billTiktok.payment.shipping_fee);
        this.invoice.tax = Number(billTiktok.payment.tax);
        this.addInvoiceDetail(billTiktok.line_items);
        this.setSubTotal();
        this.invoice.order_number_ecommerce = (billTiktok['id'].toString());
        this.invoice.id_shop = (this.infoShop._id);
        this.invoice.note = (`${this.lang.translate("Order number")} Tiktok ${billTiktok.id}`);
        this.invoice.tax_buyerDisplayName = this.invoice.tax_buyerDisplayName ? this.invoice.tax_buyerDisplayName : 'Người mua không lấy hóa đơn';
        this.invoice.cqt_status = billTiktok.cqt_status ? billTiktok.cqt_status : 1;
    }
    /**
     * tính và gán lại cộng tiền (subTotal) của đơn
     * @example this.setSubTotal()
...
IssueDeliveryGoodsComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineComponent"]({ type: IssueDeliveryGoodsComponent, selectors: [["app-issue-delivery-goods"]], decls: 41, vars: 32, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["id", "tiktok-issue-invoice"], ["nz-row", "", "nzGutter", "4", 1, "tiktok-issue-invoice-header"], ["nz-col", "", "nzSpan", "8", 1, "title"], [1, "color-green"], ["nz-col", "", "nzSpan", "6", 1, "title", "center-all-content"], [3, "nzSuffix"], ["type", "text", "nz-input", "", 3, "ngModel", "placeholder", "ngModelChange"], ["suffixIconSearch", ""], ["nz-col", "", "nzSpan", "6"], ["nzFormat", "dd/MM/yyyy", 3, "nzDisabledDate", "ngModel", "ngModelChange"], ["nz-col", "", "nzSpan", "4", 1, "right-all-content"], [2, "display", "flex", "gap", "4px"], ["nz-button", "", "nzType", "default", 1, "btn-view", "center-all-content", 3, "click"], ["src", "assets/icon/management/view.svg"], ["nz-button", "", 1, "btn-green", 3, "disabled", "click"], ["nz-row", "", "nzGutter", "16", "class", "tiktok-issue-invoice-body", 4, "ngIf", "ngIfElse"], ["class", "full-height"], ["no_bill", ""], ["no_data", ""], ["updateForControl", ""], [3, "title", "visible_affiliate", "listProductApp", "searchProductAppValue", "cancelAffiliate", "searchProductApp", "acceptAfiliate"], ["nz-icon", "", "nzType", "search"], ["nz-row", "", "nzGutter", "16", 1, "tiktok-issue-invoice-body"], ["nz-col", "", "nzSpan", "24"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzPageSize", "nzPageSizeOptions", "nzScroll", "nzData", 4, "ngIf", "ngIfElse"], ["nzShowPagination", "", "nzShowSizeChanger", "", 3, "nzPageSize", "nzPageSizeOptions", "nzScroll", "nzData"], ["salesOrder_show", ""], ["nzWidth", "8%", 2, "text-align", "center"], ["nzWidth", "17%"], ["nzWidth", "20%"], ["nzWidth", "15%", 2, "text-align", "right"], ["nzAlign", "center", "nzWidth", "20%"], ["nzAlign", "center", "nzWidth", "10%"], ["nz-checkbox", "", 1, "product-item-checkbox", 2, "margin-left", "8px", 3, "ngModel", "ngModelChange"], ["style", "cursor: pointer;", 3, "click", 4, "ngFor", "ngForOf"], [2, "cursor", "pointer", 3, "click"], [2, "text-align", "center"], ["nzLeft", ""], ["nz-icon", "", "nzType", "copy", "nzTheme", "outline", 3, "click"], ["style", "font-size: 0.8rem;", 3, "color", 4, "ngFor", "ngForOf"], [2, "text-align", "right"], ["nzAlign", "center"], ["class", "invoice-create", 3, "click", 4, "ngIf"], ["class", "invoice-view", 3, "click", 4, "ngIf"], ["class", "product-item-checkbox", "nz-checkbox", "", 3, "ngModel", "ngModelChange", 4, "ngIf"], [2, "font-size", "0.8rem"], ["class", "icon-link green", "nz-icon", "", "nzType", "link", "nzTheme", "outline", 3, "click", 4, "ngIf"], ["nz-icon", "", "nzType", "link", "nzTheme", "outline", 1, "icon-link", "green", 3, "click"], [1, "invoice-create", 3, "click"], [1, "invoice-view", 3, "click"], ["nz-checkbox", "", 1, "product-item-checkbox", 3, "ngModel", "ngModelChange"], ["nz-col", "", "nzSpan", "24", "style", "height: 60vh;", "class", "center-all-content", 4, "ngIf"], ["nz-col", "", "nzSpan", "24", 1, "center-all-content", 2, "height", "60vh"], ["nz-row", "", 1, "no-affiliate"], ["nz-col", "", "nzSpan", "24", 1, "text-center"], ["src", "assets/icon/management/ecommerce/no-data-orderstatus.svg", "alt", ""], ["nz-row", ""], ["nzFormat", "dd/MM/yyyy", 2, "margin-left", "20px", 3, "ngModel", "ngModelChange"]], template: function IssueDeliveryGoodsComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵproperty"]("title", _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵpipeBind1"](40, 30, "Select Tiktok linked products"))("visible_affiliate", ctx.visible_affiliate)("listProductApp", ctx.listProductApp)("searchProductAppValue", ctx.searchProductAppValue);
    } }, directives: [ng_zorro_antd_grid__WEBPACK_IMPORTED_MODULE_9__.NzRowDirective, ng_zorro_antd_icon__WEBPACK_IMPORTED_MODULE_10__.NzIconDirective, ng_zorro_antd_core_transition_patch__WEBPACK_IMPORTED_MODULE_11__["ɵNzTransitionPatchDirective"], ng_zorro_antd_layout__WEBPACK_IMPORTED_MODULE_12__.NzLayoutComponent, ng_zorro_antd_grid__WEBPACK_IMPORTED_MODULE_9__.NzColDirective, ng_zorro_antd_input__WEBPACK_IMPORTED_MODULE_13__.NzInputGroupComponent, ng_zorro_antd_input__WEBPACK_IMPORTED_MODULE_13__.NzInputGroupWhitSuffixOrPrefixDirective, ng_zorro_antd_input__WEBPACK_IMPORTED_MODULE_13__.NzInputDirective, _angular_forms__WEBPACK_IMPORTED_MODULE_14__.DefaultValueAccessor, _angular_forms__WEBPACK_IMPORTED_MODULE_14__.NgControlStatus, _angular_forms__WEBPACK_IMPORTED_MODULE_14__.NgModel, ng_zorro_antd_date_picker__WEBPACK_IMPORTED_MODULE_15__.NzDatePickerComponent, ng_zorro_antd_date_picker__WEBPACK_IMPORTED_MODULE_15__.NzRangePickerComponent, ng_zorro_antd_button__WEBPACK_IMPORTED_MODULE_16__.NzButtonComponent, ng_zorro_antd_core_wave__WEBPACK_IMPORTED_MODULE_17__.NzWaveDirective, _ionic_angular__WEBPACK_IMPORTED_MODULE_18__.IonIcon, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgIf, _components_modal_link_product_ecommerce_modal_link_product_ecommerce_component__WEBPACK_IMPORTED_MODULE_3__.ModalLinkProductEcommerceComponent, ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_19__.NzTableComponent, ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_19__.NzTheadComponent, ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_19__.NzTrDirective, ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_19__.NzTableCellDirective, ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_19__.NzThMeasureDirective, ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_19__.NzCellAlignDirective, ng_zorro_antd_checkbox__WEBPACK_IMPORTED_MODULE_20__.NzCheckboxComponent, ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_19__.NzTbodyComponent, _angular_common__WEBPACK_IMPORTED_MODULE_7__.NgForOf, ng_zorro_antd_table__WEBPACK_IMPORTED_MODULE_19__.NzCellFixedDirective], pipes: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_21__.TranslatePipe, _angular_common__WEBPACK_IMPORTED_MODULE_7__.DatePipe], styles: [".row-back[_ngcontent-%COMP%] {\n  margin-top: 8px;\n  cursor: pointer;\n}\n.row-back[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  margin-top: 2px;\n}\nnz-layout[_ngcontent-%COMP%] {\n  background: #ffffff 0% 0% no-repeat padding-box;\n  box-shadow: 0px 2px 6px #00000014;\n  border-radius: 5px;\n  padding: 16px;\n  height: 95%;\n}\nnz-layout[_ngcontent-%COMP%]   .title[_ngcontent-%COMP%] {\n  color: var(--ion-color-vh-green);\n  font-size: 1.1rem;\n}\nnz-layout[_ngcontent-%COMP%]   .center-text[_ngcontent-%COMP%] {\n  text-align: center;\n}\nnz-layout[_ngcontent-%COMP%]   .tiktok-issue-invoice-header[_ngcontent-%COMP%] {\n  margin-bottom: 16px;\n  display: flex;\n  align-items: center;\n}\nnz-layout[_ngcontent-%COMP%]   .tiktok-issue-invoice-header[_ngcontent-%COMP%]   nz-select[_ngcontent-%COMP%] {\n  width: 95%;\n}\nnz-layout[_ngcontent-%COMP%]   .btn-view[_ngcontent-%COMP%] {\n  background: var(--ion-color-vh-green) 0% 0% no-repeat padding-box;\n  border: 1px solid #ffffff;\n  border-radius: 5px;\n  width: 95%;\n  color: #ffffff;\n}\nnz-layout[_ngcontent-%COMP%]   .btn-view[_ngcontent-%COMP%]   ion-icon[_ngcontent-%COMP%] {\n  font-size: 0.9rem;\n  padding-right: 5px;\n}\nnz-layout[_ngcontent-%COMP%]   .invoice[_ngcontent-%COMP%] {\n  font-size: 0.9rem;\n}\nnz-layout[_ngcontent-%COMP%]   .invoice-create[_ngcontent-%COMP%] {\n  cursor: pointer;\n  color: var(--ion-color-vh-green);\n}\nnz-layout[_ngcontent-%COMP%]   .invoice-view[_ngcontent-%COMP%] {\n  cursor: pointer;\n  color: var(--ion-color-vh-black);\n}\nnz-layout[_ngcontent-%COMP%]   .no-affiliate[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 100%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\nnz-layout[_ngcontent-%COMP%]   .no-affiliate[_ngcontent-%COMP%]   img[_ngcontent-%COMP%] {\n  width: 25vh;\n  max-width: 250px;\n  height: auto;\n}\nnz-layout[_ngcontent-%COMP%]   .no-affiliate[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  font-size: 0.9rem;\n  color: var(--ion-color-vh-black);\n  margin-top: 8px;\n}\nnz-layout[_ngcontent-%COMP%]   .no-affiliate[_ngcontent-%COMP%]   .text-center[_ngcontent-%COMP%] {\n  text-align: center;\n}\nnz-layout[_ngcontent-%COMP%]   .icon-link[_ngcontent-%COMP%] {\n  padding: 1px;\n  font-size: 12px;\n  border-radius: 4px;\n  cursor: pointer;\n}\nnz-layout[_ngcontent-%COMP%]   .icon-link.green[_ngcontent-%COMP%] {\n  border: 1px solid var(--ion-color-vh-green);\n  color: var(--ion-color-vh-green);\n}\n.date-picker-cus[_ngcontent-%COMP%] {\n  width: 97%;\n  border: 1px solid #d9d9d9;\n}\n.date-picker-cus[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  color: var(--ion-color-vh-gray) !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
/***/ 16246:
/*!**********************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/issue-invoice/issue-delivery-goods/issue-delivery-goods.module.ts ***!
  \**********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _issue_delivery_goods_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./issue-delivery-goods.component */ 29140);
/* harmony import */ var _add_add_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./add/add.component */ 76210);
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail/detail.component */ 70957);
...
/* harmony import */ var _detailTiktok_detail_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./detailTiktok/detail.component */ 45418);
/* harmony import */ var _edit_edit_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edit/edit.component */ 20120);
/* harmony import */ var src_app_sales_components_bill_type_bill_type_1_tiktok_bill_type1_tiktok_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/sales/components/bill-type/bill-type-1/tiktok/bill-type1-tiktok.module */ 92871);
...
const routes = [
    ...
    {
        path: "detail-tiktok",
        component: _detailTiktok_detail_component__WEBPACK_IMPORTED_MODULE_4__.DetailComponentTiktok
    }
];
...
IssueDeliveryGoodsModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjector"]({ imports: [[
            ...
            src_app_sales_components_bill_type_bill_type_1_tiktok_bill_type1_tiktok_module__WEBPACK_IMPORTED_MODULE_6__.BillType1TiktokModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵsetNgModuleScope"](IssueDeliveryGoodsModule, { declarations: [_issue_delivery_goods_component__WEBPACK_IMPORTED_MODULE_0__.IssueDeliveryGoodsComponent, _add_add_component__WEBPACK_IMPORTED_MODULE_1__.AddComponent, _detail_detail_component__WEBPACK_IMPORTED_MODULE_2__.DetailComponent, _detailTiktok_detail_component__WEBPACK_IMPORTED_MODULE_4__.DetailComponentTiktok, _edit_edit_component__WEBPACK_IMPORTED_MODULE_5__.EditComponent], imports: [_angular_common__WEBPACK_IMPORTED_MODULE_9__.CommonModule, _angular_router__WEBPACK_IMPORTED_MODULE_10__.RouterModule, src_app_ng_zorro_ant_module__WEBPACK_IMPORTED_MODULE_3__.NgZorroAntModule,
        _ngx_translate_core__WEBPACK_IMPORTED_MODULE_11__.TranslateModule,
        _ionic_angular__WEBPACK_IMPORTED_MODULE_12__.IonicModule,
        _angular_forms__WEBPACK_IMPORTED_MODULE_13__.FormsModule,
        src_app_sales_components_bill_type_bill_type_1_tiktok_bill_type1_tiktok_module__WEBPACK_IMPORTED_MODULE_6__.BillType1TiktokModule,
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_tiktok_issue-invoice_issue-delivery-goods_issue-delivery--362649.js.map