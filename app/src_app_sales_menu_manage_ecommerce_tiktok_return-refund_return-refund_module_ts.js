"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_tiktok_return-refund_return-refund_module_ts"],{

/***/ 73330:
/*!*********************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/return-refund/return-refund.component.ts ***!
  \*********************************************************************************************/
...
class ReturnRefundComponent {
    ...
    */
            ...
            this.modal.confirm({
                ...
                nzOnOk: () => {
                    return new Promise((resolve, reject) => {
                        ...
                        this.vhEcommerce.updateSalesOrderTiktok(this.infoShop._id, bill.order_id.toString(), value).then((bool) => {
                            if (bool) {
            ...
            this.modal.confirm({
                ...
                nzOnOk: () => {
                    return new Promise((resolve, reject) => {
                        ...
                        this.vhEcommerce.updateSalesOrderTiktok(this.infoShop._id, bill.order_id.toString(), value).then(res => {
                            if (res)
                                resolve(true);
                            else
                                reject(false);
    ...
    saveNote(clear) {
        if (clear) {
            this.vhComponent.alertConfirm(this.lang.translate('Confirm'), '', this.lang.translate("Delete note") + "?", "Ok", this.lang.translate("Cancel"))
                ...
                this.vhEcommerce.updateSalesOrderTiktok(this.infoShop._id, this.billViewNote.order_id.toString(), { note_psc: "" })
                    .then(res => {
                    this.billViewNote['showLoading1'] = false;
            ...
            this.vhComponent.alertConfirm(this.lang.translate('Confirm'), '', this.lang.translate("Update") + "?", "Ok", this.lang.translate("Cancel"))
                ...
                this.vhEcommerce.updateSalesOrderTiktok(this.infoShop._id, this.billViewNote.order_id.toString(), { note_psc: note })
                    .then(res => {
                    this.billViewNote['showLoading2'] = false;
    ...
    updateProcess(order) {
        this.vhEcommerce.updateSalesOrderTiktok(this.infoShop._id, order.order_id.toString(), { called_psc: !order.called_psc }).then(() => {
            order.called_psc = !order.called_psc;
            this.segmentChanged(this.indexSegment);
        }).catch(err => console.error(err));
    }
    gotoDetail(bill) {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/return-refund/detail'], {
            state: {
                bill: bill,
                dataRestore: {
...
/***/ 71762:
/*!******************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/return-refund/return-refund.module.ts ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _return_refund_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./return-refund.component */ 73330);
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_tiktok_return-refund_return-refund_module_ts.js.map