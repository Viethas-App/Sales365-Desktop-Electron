"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_ecommerce_tiktok_update-stock_update-stock_module_ts"],{

/***/ 88151:
/*!*******************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/update-stock/update-stock.component.ts ***!
  \*******************************************************************************************/
...
class UpdateStockComponent {
    ...
    gotobyProductApp() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/update-stock/by-product-app']);
    }
    gotobyProductTiktok() {
        this.router.navigate(['/sales/dashboard/manage/ecommerce/tiktok/update-stock/by-product-tiktok']);
    }
}
...
UpdateStockComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: UpdateStockComponent, selectors: [["app-update-stock"]], decls: 31, vars: 12, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["nz-row", ""], ["nz-col", "", "nzSpan", "24", 1, "title"], ["nz-row", "", 1, "cus-row"], ["nz-col", "", "nzSpan", "6", 1, "center-all-content", "item-cus"], [1, "ng-item", "center-all-content", 3, "click"], ["nz-col", "", "nzSpan", "24", 1, "center-all-content"], ["src", "assets/icon/management/ecommerce/by-product-app.svg"], [1, "center-text", "medium-size"], ["src", "assets/icon/management/ecommerce/by-product-sendo.svg"]], template: function UpdateStockComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UpdateStockComponent_Template_div_click_22_listener() { return ctx.gotobyProductTiktok(); });
...
/***/ 69966:
/*!****************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/ecommerce/tiktok/update-stock/update-stock.module.ts ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _update_stock_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./update-stock.component */ 88151);
...
const routes = [
    ...
    {
        path: 'by-product-app',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_sales_menu_manage_ecommerce_tiktok_update-stock_by-product-app_by-product-app_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./by-product-app/by-product-app.module */ 53810)).then(m => m.ByProductAppModule)
    },
    {
        path: 'by-product-tiktok',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_sales_menu_manage_ecommerce_tiktok_update-stock_by-product-tiktok_by-product-tiktok_m-db22fb").then(__webpack_require__.bind(__webpack_require__, /*! ./by-product-tiktok/by-product-tiktok.module */ 32377)).then(m => m.ByProductTiktokModule)
    },
];
...
//# sourceMappingURL=src_app_sales_menu_manage_ecommerce_tiktok_update-stock_update-stock_module_ts.js.map