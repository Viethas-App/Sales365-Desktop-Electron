"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_sales-program_coupons_design_design_module_ts"],{

/***/ 99061:
/*!************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/sales-program/coupons/design/design.component.ts ***!
  \************************************************************************************/
...
class DesignComponent {
    ...
    /**
     * get dữ liệu mẫu thiết kế type 2 cho thẻ trả trước
     */
    getData() {
    ...
    initForm() {
        this.formAdd = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormGroup({
            ...
            type: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControl(2),
            img: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__.FormControl('assets/img/sample_coupon.jpg'),
    ...
    gotoEdit(item) {
        this.router.navigate(['/sales/dashboard/manage/sales-program/coupons/design/detail'], { state: item });
    }
    /**
...
DesignComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: DesignComponent, selectors: [["app-design"]], decls: 26, vars: 25, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["nz-row", ""], ["nz-col", "", "nzSpan", "21", 1, "title", "left-all-content"], ["nz-col", "", "nzSpan", "3", 1, "add-button"], ["nz-button", "", "nzType", "default", 1, "btn-add", "center-all-content", 3, "click"], ["nz-icon", "", "nzType", "plus", "nzTheme", "outline"], ["nz-col", "", "nzSpan", "12", 4, "ngFor", "ngForOf"], ["nz-row", "", 1, "center-all-content"], ["nz-col", "", "nzSpan", "12"], ["nzNotFoundImage", "simple", 3, "nzNotFoundContent", 4, "ngIf"], [3, "nzWidth", "nzMaskClosable", "nzVisible", "nzOkDisabled", "nzTitle", "nzVisibleChange", "nzOnCancel", "nzOnOk"], [4, "nzModalContent"], ["type", "button", "mode", "md"], [3, "click"], ["name", "create-outline", "slot", "end", "nzTooltipPlacement", "bottom", "nz-tooltip", "", 1, "icon_edit", 3, "nzTooltipTitle", "nzTooltipColor", "click"], ["nzTooltipPlacement", "bottom", "nz-tooltip", "", "name", "trash-outline", "slot", "end", 1, "icon_delete", 3, "nzTooltipTitle", "nzTooltipColor", "click"], ["nzNotFoundImage", "simple", 3, "nzNotFoundContent"], [3, "formGroup"], ["type", "text", "nz-input", "", "formControlName", "name", 3, "placeholder"], ["type", "number", "nz-input", "", "formControlName", "width", 3, "placeholder"], ["type", "number", "nz-input", "", "formControlName", "height", 3, "placeholder"], ["type", "text", "nz-input", "", 3, "ngModel", "ngModelChange"]], template: function DesignComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵpipeBind1"](9, 17, "Coupon template list"));
...
/***/ 57568:
/*!*********************************************************************************!*\
  !*** ./src/app/sales/menu/manage/sales-program/coupons/design/design.module.ts ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _design_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./design.component */ 99061);
/* harmony import */ var _detail_detail_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detail/detail.component */ 10045);
/* harmony import */ var _detail_print_print_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail/print/print.component */ 79741);
...
/***/ 10045:
/*!*******************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/sales-program/coupons/design/detail/detail.component.ts ***!
  \*******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class DetailComponent {
    ...
    onUpload(e) {
        ...
        this.vhImage.getThumbnailFromDesktop(file, this.stamp.width * 3.78, this.stamp.height * 3.78, "design-coupons", this.stamp['img'] || '').then(photoURL => {
...
/***/ 79741:
/*!************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/sales-program/coupons/design/detail/print/print.component.ts ***!
  \************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var qrcode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! qrcode */ 17988);
        ...
        if (this.stamp.barcode)
            for (let i = 0; i < this.stamp.number; i++) {
                if (this.stamp.barcode.property[2].value)
                    qrcode__WEBPACK_IMPORTED_MODULE_1__.toCanvas(document.getElementById('canvas' + i), this.stamp.barcode.property[2].value, { width: parseInt(this.stamp.barcode.property[3].height) * 3.78 }, function (error) {
                        if (error)
                            console.error(error);
                    });
                if (this.stamp.barcode.property[2].value)
                    jsbarcode__WEBPACK_IMPORTED_MODULE_2___default()(".barcode", this.stamp.barcode.property[2].value, {
                        displayValue: false,
                    });
            }
    }
    goBack() {
        this.router.navigate(['/sales/dashboard/manage/sales-program/coupons/design/detail'], { state: this.stamp.barcode });
    }
    printBrowser() {
...
//# sourceMappingURL=src_app_sales_menu_manage_sales-program_coupons_design_design_module_ts.js.map