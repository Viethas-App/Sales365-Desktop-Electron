"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_menu_manage_sales-program_discount-employee_sales-discount_sales-discount_module_ts"],{

/***/ 52904:
/*!***************************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/sales-program/discount-employee/sales-discount/list-discount/list-discount.component.ts ***!
  \***************************************************************************************************************************/
...
class ListDiscountComponent {
    constructor(router, vhQuerySales, vhAlgorithm, languageService, cdRef, vhQuery, vhComponent, vhAuth, nzModalService) {
        this.router = router;
    ...
    getData() {
        this.vhComponent.showLoading('').then(() => {
            this.vhQuerySales.getCommissions().then((response) => {
    ...
    goBack() {
        this.router.navigate(['/sales/dashboard/manage/sales-program/discount-employee/sales-discount']);
    }
    /**
    ...
    addDiscountDB() {
        ...
        if (this.form_add.valid)
            this.vhComponent.showLoading('').then(() => {
                this.vhQuerySales.addCommission(this.form_add.value).then((response) => {
                    this.show_add_commission_modal = false;
    ...
    updateDiscountDB() {
        ...
        this.vhComponent.showLoading('').then(() => {
            this.vhQuerySales.updateCommission(this.form_edit.value._id, this.form_edit.value).then((bool) => {
                this.show_edit_commission_modal = false;
                if (bool) {
    ...
    deleleDiscount(data) {
        this.vhComponent.showLoading('').then(() => {
            this.vhQuerySales.deleteCommission(data._id).then(bool => {
                this.vhComponent.hideLoading(0);
                if (bool) {
...
/***/ 73838:
/*!**************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/sales-program/discount-employee/sales-discount/sales-discount.component.ts ***!
  \**************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class SalesDiscountComponent {
    ...
    gotoReportDiscount() {
        this.router.navigate(['/sales/dashboard/manage/sales-program/discount-employee/sales-discount/show-report']);
    }
    goBack() {
...
SalesDiscountComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SalesDiscountComponent, selectors: [["app-sales-discount"]], decls: 33, vars: 12, consts: [["nz-row", "", 1, "row-back", "medium-size", 3, "click"], ["nz-icon", "", "nzType", "left", "nzTheme", "outline"], ["nz-row", ""], ["nz-col", "", "nzSpan", "24", 1, "title"], ["nz-row", "", 1, "cus-row"], ["nz-col", "", "nzSpan", "6", 1, "center-all-content", "item-cus"], [1, "ng-item", "center-all-content", 3, "click"], ["nz-col", "", "nzSpan", "24", 1, "center-all-content"], ["src", "assets/icon/management/cong_thuc_chiet_khau.svg"], [1, "center-text"], ["src", "./assets/icon/management/xem_chiet_khau.svg"], ["nz-col", "", "nzSpan", "6", 1, "center-all-content"]], template: function SalesDiscountComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](9, 6, "Commission based on sales value"));
...
/***/ 65581:
/*!***********************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/sales-program/discount-employee/sales-discount/sales-discount.module.ts ***!
  \***********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _sales_discount_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sales-discount.component */ 73838);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ 71258);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ionic/angular */ 7602);
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ngx-translate/core */ 70325);
/* harmony import */ var _list_discount_list_discount_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list-discount/list-discount.component */ 52904);
/* harmony import */ var _show_report_show_report_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./show-report/show-report.component */ 22627);
...
/***/ 22627:
/*!***********************************************************************************************************************!*\
  !*** ./src/app/sales/menu/manage/sales-program/discount-employee/sales-discount/show-report/show-report.component.ts ***!
  \***********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class ShowReportComponent {
     ...
     */
    getListEmployee() {
        for (let item of this.vhAuth.getlocalEmployees().filter(item => item.owner == 'member')) {
    ...
    getSales(id_employee, startDate, endDate) {
        this.vhComponent.showLoading("", "transparent-loading").then(() => {
            this.vhQuerySales.getReportCommission_Employees(startDate, endDate, id_employee, this.id_branch_report)
                .then((res) => {
                if (res) {
                    if (!res.empty) {
                        //this.isChart = false 
    ...
    export() {
        ...
        for (let _row of this.dataReport['dataTable'].docs) {
            ...
            item[this.languageService.translate('Tên hoa hồng')] = _row.commission_name;
            item[this.languageService.translate('Sales before tax')] = _row.sales_btax;
            item[this.languageService.translate('Hoa hồng trước thuế')] = _row.commission_btax;
            item[this.languageService.translate('Sales after tax')] = _row.sales_atax;
            item[this.languageService.translate('Hoa hồng sau thuế')] = _row.commission_atax;
            data.push(item);
        }
...
//# sourceMappingURL=src_app_sales_menu_manage_sales-program_discount-employee_sales-discount_sales-discount_module_ts.js.map