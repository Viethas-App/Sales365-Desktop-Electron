"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_sales-pos_components_invoices-detail-pos_invoices-detail-pos_module_ts"],{

/***/ 73232:
/*!***************************************************************************************!*\
  !*** ./src/app/sales/sales-pos/components/invoices-detail-pos/edit/edit.component.ts ***!
  \***************************************************************************************/
...
EditComponent.ɵcmp = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: EditComponent, selectors: [["app-edit"]], decls: 1, vars: 1, consts: [[3, "url"]], template: function EditComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("url", "/sales/sales-pos/invoices-pos");
...
/***/ 53503:
/*!*************************************************************************************************!*\
  !*** ./src/app/sales/sales-pos/components/invoices-detail-pos/invoices-detail-pos.component.ts ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class InvoicesDetailPosComponent {
    ...
    setSubTotal() {
        ...
        for (let i of this.invoice_detail) {
            ...
            if (i.products_gift) {
                total_product_gift = i.products_gift.reduce((prev, next) => prev + next.quantity * next.price, 0);
            }
            else if (i.products) {
                ...
                this.vhComponent.showLoading("", "transparent-loading").then(() => {
                    this.vhQuerySales.deleteBill_Billdetail(this.invoice._id).then(() => {
                        ...
                        this.vhComponent.hideLoading(0).then(() => {
                            ...
                            this.router.navigate(['/sales/sales-pos/invoices-pos'], { state: this.dataRestore });
                        });
                    });
                });
            }, () => { });
    ...
    goToCart() {
        this.router.navigate(['/sales/sales-pos'], { state: { invoiceDetail: this.invoice_detail, invoice: this.invoice } });
    }
    /**
    ...
    */
    ...
    editInvoice() {
        this.router.navigate(["/sales/sales-pos/invoices-pos/invoices-detail-pos/edit"], { state: { invoiceDetail: this.invoice_detail, invoice: this.invoice, dataRestore: this.dataRestore } });
    }
}
...
/***/ 39768:
/*!**********************************************************************************************!*\
  !*** ./src/app/sales/sales-pos/components/invoices-detail-pos/invoices-detail-pos.module.ts ***!
  \**********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _invoices_detail_pos_invoices_detail_pos_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../invoices-detail-pos/invoices-detail-pos.component */ 53503);
/* harmony import */ var src_app_ng_zorro_ant_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/ng-zorro-ant.module */ 12760);
/* harmony import */ var _ngx_translate_core__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ngx-translate/core */ 70325);
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/forms */ 1707);
/* harmony import */ var _ionic_angular__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @ionic/angular */ 7602);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/router */ 71258);
/* harmony import */ var _edit_edit_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit/edit.component */ 73232);
...
//# sourceMappingURL=src_app_sales_sales-pos_components_invoices-detail-pos_invoices-detail-pos_module_ts.js.map