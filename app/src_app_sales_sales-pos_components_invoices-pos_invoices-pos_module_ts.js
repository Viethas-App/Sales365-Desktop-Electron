"use strict";
(self["webpackChunkSales365_Viethas"] = self["webpackChunkSales365_Viethas"] || []).push([["src_app_sales_sales-pos_components_invoices-pos_invoices-pos_module_ts"],{

/***/ 63326:
/*!***********************************************************************************!*\
  !*** ./src/app/sales/sales-pos/components/invoices-pos/invoices-pos.component.ts ***!
  \***********************************************************************************/
...
class InvoicesPosComponent {
    ...
    goToDetail(id) {
        ...
        if (this.vhAuth.checkMyPermission("sales_enable_view_bill_today"))
            this.router.navigate(["/sales/sales-pos/invoices-pos/invoices-detail-pos"], { state: { id: id, dataRestore } });
        else
    ...
    //back 
    goBack() {
        this.router.navigate(['/sales/sales-pos'], { state: { isSync: true } });
    }
...
/***/ 672:
/*!********************************************************************************!*\
  !*** ./src/app/sales/sales-pos/components/invoices-pos/invoices-pos.module.ts ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _invoices_pos_invoices_pos_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../invoices-pos/invoices-pos.component */ 63326);
...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_sales_sale-desktop_components_components_module_ts"), __webpack_require__.e("default-src_app_sales_components_bill-type_bill-type-1_sales-desktop_sales-desktop-bill-type1-781d48"), __webpack_require__.e("src_app_sales_sales-pos_components_invoices-detail-pos_invoices-detail-pos_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../invoices-detail-pos/invoices-detail-pos.module */ 39768)).then(m => m.InvoicesDetailPosModule)
    },
];
...
//# sourceMappingURL=src_app_sales_sales-pos_components_invoices-pos_invoices-pos_module_ts.js.map